...
POST /api/framework/geo-redundancy/region/{region_id}/failover</pre>
    ...
    `}function Le(){let e=document.getElementById(`create-region-dialog`);e&&e.remove()}function Re(){Le(),document.body.insertAdjacentHTML(`beforeend`,`
...
features:
  team_messaging:
    ...
    `}window.frameworkFeatures={loadFrameworkOverview:a,loadClickToDialTab:o,loadVideoConferencingTab:l,loadConversationalAITab:te,loadPredictiveDialingTab:ie,loadVoiceBiometricsTab:le,loadCallQualityPredictionTab:he,loadVideoCodecTab:ge,loadBIIntegrationTab:_e,loadCallTaggingTab:ye,loadMobileAppsTab:ke,loadMobileNumberPortabilityTab:Me,loadRecordingAnalyticsTab:Ne,loadCallBlendingTab:Pe,loadVoicemailDropTab:Fe,loadGeographicRedundancyTab:Ie,loadDNSSRVFailoverTab:ze,loadSessionBorderControllerTab:Be,loadDataResidencyTab:Ve,loadTeamMessagingTab:He,viewClickToDialHistory:c,loadConversationalAIStats:ne,loadMobileAppsStats:Ae,exportBIDataset:ve,loadCallTags:be,loadTaggingRules:f,loadTagStatistics:xe,showCreateTagDialog:Ce,showCreateRuleDialog:Te,deleteTag:Ee,deleteRule:De,toggleRule:Oe,loadPredictiveDialingCampaigns:d,loadPredictiveDialingStats:ae,showCreateCampaignDialog:se,toggleCampaign:ce,loadVoiceBiometricProfiles:ue,loadVoiceBiometricStats:de,showEnrollUserDialog:pe,hideEnrollUserDialog:fe,deleteVoiceProfile:me,hideCreateCampaignDialog:oe,showCreateRegionDialog:Re,hideCreateRegionDialog:Le,hideCreateTagDialog:Se,hideCreateRuleDialog:we,submitConversationalAIConfig:re,submitMobileAppsConfig:je};for(let e of Object.keys(window.frameworkFeatures))typeof window.frameworkFeatures[e]==`function`&&(window[e]=window.frameworkFeatures[e]);var Ue=`80`,We=`443`,Ge=`9000`,Ke=3e4;function p(){let e=document.querySelector(`meta[name="api-base-url"]`);return e&&e.content?e.content:window.location.port===Ge||window.location.port===``||window.location.port===Ue||window.location.port===We?window.location.origin:`${window.location.protocol}//${window.location.hostname||`localhost`}:${Ge}`}function m(){let e=localStorage.getItem(`pbx_token`),t={"Content-Type":`application/json`};return e&&(t.Authorization=`Bearer ${e}`),t}async function h(e,t={},n=Ke){if(t.signal)throw Error(`fetchWithTimeout does not support custom abort signals. Use the timeout parameter instead.`);let r=new AbortController,i=setTimeout(()=>r.abort(),n);try{return await fetch(e,{...t,signal:r.signal})}catch(e){throw e instanceof Error&&e.name===`AbortError`?Error(`Request timed out`):e}finally{clearTimeout(i)}}var qe=new class{_state;_listeners;constructor(e){this._state={...e},this._listeners=new Map}get(e){return this._state[e]}set(e,t){this._state[e]=t;let n=this._listeners.get(e)??[];for(let e of n)e(t)}subscribe(e,t){return this._listeners.has(e)||this._listeners.set(e,[]),this._listeners.get(e).push(t),()=>{let n=this._listeners.get(e);if(!n)return;let r=n.indexOf(t);r>-1&&n.splice(r,1)}}getState(){return{...this._state}}}({currentUser:null,currentExtensions:[],currentTab:`dashboard`,isAuthenticated:!1,autoRefreshInterval:null});function g(e){return String(e).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`).replace(/'/g,`&#39;`)}async function Je(e){try{await navigator.clipboard.writeText(e),_(`License data copied to clipboard!`,`success`)}catch(e){console.error(`Error copying to clipboard:`,e),_(`Failed to copy to clipboard`,`error`)}}function Ye(e){if(!e)return``;try{return new Date(e).toLocaleString()}catch{return e}}function Xe(e,t){return e.length<=t?e:e.substring(0,t)+`...`}function Ze(e){let t=new Date().getTime()-new Date(e).getTime(),n=Math.floor(t/(1e3*60*60)),r=Math.floor(t%(1e3*60*60)/(1e3*60));return n>0?`${n}h ${r}m`:`${r}m`}function Qe(e){return{registered:`<span class="badge" style="background: #10b981;">&#x2705; Registered</span>`,unregistered:`<span class="badge" style="background: #6b7280;">&#x26AA; Unregistered</span>`,failed:`<span class="badge" style="background: #ef4444;">&#x274C; Failed</span>`,disabled:`<span class="badge" style="background: #9ca3af;">&#x23F8;&#xFE0F; Disabled</span>`,degraded:`<span class="badge" style="background: #f59e0b;">&#x26A0;&#xFE0F; Degraded</span>`}[e]||e}function $e(e){return{healthy:`<span class="badge" style="background: #10b981;">&#x1F49A; Healthy</span>`,warning:`<span class="badge" style="background: #f59e0b;">&#x26A0;&#xFE0F; Warning</span>`,critical:`<span class="badge" style="background: #f59e0b;">&#x1F534; Critical</span>`,down:`<span class="badge" style="background: #ef4444;">&#x1F480; Down</span>`}[e]||e}function et(e){return{1:`<span class="badge" style="background: #ef4444;">1 - Highest</span>`,2:`<span class="badge" style="background: #f97316;">2 - High</span>`,3:`<span class="badge" style="background: #eab308;">3 - Medium</span>`,4:`<span class="badge" style="background: #3b82f6;">4 - Low</span>`,5:`<span class="badge" style="background: #6b7280;">5 - Lowest</span>`}[e]||`<span class="badge">${e}</span>`}function tt(e){return e>=4.3?`quality-excellent`:e>=4?`quality-good`:e>=3.6?`quality-fair`:e>=3.1?`quality-poor`:`quality-bad`}function nt(e){let t=[];if(e.days_of_week){let n=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],r=e.days_of_week.map(e=>n[e]).join(`, `);t.push(r)}return e.start_time&&e.end_time&&t.push(`${e.start_time}-${e.end_time}`),e.holidays===!0?t.push(`Holidays`):e.holidays===!1&&t.push(`Non-holidays`),t.length>0?t.join(` | `):`Always`}function rt(e){let t=JSON.stringify(e,null,2),n=new Blob([t],{type:`application/json`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`license_${e.issued_to.replace(/[^a-zA-Z0-9]/g,`_`).toLowerCase()}_${new Date().toISOString().split(`T`)[0]}.json`,document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(r)}window.formatDate=Ye,window.truncate=Xe,window.getDuration=Ze,window.getStatusBadge=Qe,window.getHealthBadge=$e,window.getPriorityBadge=et,window.getQualityClass=tt,window.getScheduleDescription=nt,window.downloadLicense=rt;var it={enabled:!0,displayTime:8e3,maxErrors:5,showStackTrace:!0},at=[],ot=!1;function st(e){ot=e}function _(e,t=`info`){if(ot&&t===`error`){debugLog(`[${t.toUpperCase()}] ${e}`);return}let n=document.createElement(`div`);n.className=`notification notification-${t}`,n.style.cssText=`
        position: fixed;
        top: 80px;
        right: 20px;
        max-width: 400px;
        ...
        font-size: 14px;
        line-height: 1.4;
    `,n.innerHTML=`<strong>${t===`success`?`✓`:t===`error`?`✗`:t===`warning`?`⚠`:`ℹ`}</strong> ${g(e)}`,document.body.appendChild(n),setTimeout(()=>{n.style.animation=`slideOutRight 0.3s ease-in`,setTimeout(()=>n.remove(),300)},5e3)}function v(e,t=``){if(!it.enabled)return;let n=`error-${Date.now()}`,r=e.message||e.toString(),i=e.stack||``;at.push({id:n,message:r,context:t,stack:i,timestamp:new Date}),at.length>it.maxErrors&&at.shift();let a=document.createElement(`div`);a.id=n,a.className=`error-notification`,a.style.cssText=`
        position: fixed;
        top: 70px;
        right: 20px;
        max-width: 450px;
    ...
    `;t&&(o+=`<div style="margin-bottom: 5px;"><strong>Context:</strong> ${g(t)}</div>`),o+=`<div style="margin-bottom: 5px;"><strong>Message:</strong> ${g(r)}</div>`,it.showStackTrace&&i&&(o+=`
    ...
    `,a.innerHTML=o;let s=a.querySelector(`#close-${n}`);s&&s.addEventListener(`click`,()=>a.remove()),document.body.appendChild(a),setTimeout(()=>{document.getElementById(n)&&(a.style.animation=`slideOut 0.3s ease-in`,setTimeout(()=>a.remove(),300))},it.displayTime),console.error(`[${t||`Error`}]`,r),i&&console.error(`Stack trace:`,i)}var ct=1e4,lt=null;function ut(){typeof window.loadEmergencyContacts==`function`&&window.loadEmergencyContacts(),typeof window.loadEmergencyHistory==`function`&&window.loadEmergencyHistory()}function dt(){typeof window.loadFraudAlerts==`function`&&window.loadFraudAlerts()}function ft(){typeof window.loadCallbackQueue==`function`&&window.loadCallbackQueue()}function pt(e){lt&&=(clearInterval(lt),null);let t={dashboard:()=>window.loadDashboard?.(),analytics:()=>window.loadAnalytics?.(),calls:()=>window.loadCalls?.(),qos:()=>window.loadQoSMetrics?.(),emergency:ut,"callback-queue":ft,extensions:()=>window.loadExtensions?.(),phones:()=>window.loadRegisteredPhones?.(),atas:()=>window.loadRegisteredATAs?.(),"hot-desking":()=>window.loadHotDeskSessions?.(),voicemail:()=>window.loadVoicemailTab?.(),"fraud-detection":dt,"sbc-management":()=>window.loadSBCData?.()};t[e]&&(lt=setInterval(()=>{try{let n=t[e];typeof n==`function`?n():console.error(`Auto-refresh function for ${e} is not a function:`,n)}catch(t){console.error(`Error during auto-refresh of ${e}:`,t),t instanceof Error&&t.message?.includes(`401`)&&debugWarn(`Authentication error during auto-refresh - user may need to re-login`)}},ct)),qe.set(`autoRefreshInterval`,lt)}function y(e){for(let e of document.querySelectorAll(`.tab-content`))e.classList.remove(`active`);for(let e of document.querySelectorAll(`.tab-button`))e.classList.remove(`active`);let t=document.getElementById(e);if(!t)console.error(`CRITICAL: Tab element with id '${e}' not found in DOM`),console.error(`This may indicate a UI template issue or incorrect tab name`),console.error(`Current tab name: "${e}"`);else{t.classList.add(`active`);let n=document.querySelector(`[data-tab="${e}"]`);n?n.classList.add(`active`):debugWarn(`Tab button for '${e}' not found`)}qe.set(`currentTab`,e),pt(e);let n={dashboard:window.loadDashboard,analytics:window.loadAnalytics,extensions:window.loadExtensions,phones:window.loadRegisteredPhones,atas:window.loadRegisteredATAs,provisioning:window.loadProvisioning,"auto-attendant":window.loadAutoAttendantConfig,voicemail:window.loadVoicemailTab,paging:window.loadPagingData,"call-queues":window.loadQueuesData,calls:window.loadCalls,config:window.loadConfig,"features-status":window.loadFeaturesStatus,"webrtc-phone":window.loadWebRTCPhoneConfig,"license-management":window.initLicenseManagement,qos:window.loadQoSMetrics,"find-me-follow-me":window.loadFMFMExtensions,"time-routing":window.loadTimeRoutingRules,webhooks:window.loadWebhooks,"hot-desking":window.loadHotDeskSessions,"recording-retention":window.loadRetentionPolicies,"jitsi-integration":window.loadJitsiConfig,"matrix-integration":window.loadMatrixConfig,"espocrm-integration":window.loadEspoCRMConfig,"click-to-dial":window.loadClickToDialTab,"fraud-detection":window.loadFraudDetectionData,"nomadic-e911":window.loadNomadicE911Data,"callback-queue":window.loadCallbackQueue,"mobile-push":window.loadMobilePushConfig,"recording-announcements":window.loadRecordingAnnouncements,"speech-analytics":window.loadSpeechAnalyticsConfigs,compliance:window.loadComplianceData,"crm-integrations":window.loadCRMActivityLog,"opensource-integrations":window.loadOpenSourceIntegrations,"sbc-management":window.loadSBCData},r={emergency:[window.loadEmergencyContacts,window.loadEmergencyHistory],codecs:[window.loadCodecStatus,window.loadDTMFConfig],"sip-trunks":[window.loadSIPTrunks,window.loadTrunkHealth,window.loadInboundRoutes],"least-cost-routing":[window.loadLCRRates,window.loadLCRStatistics]},i=n[e];if(i)i();else{let t=r[e];if(t)for(let e of t)e?.()}}function mt(){let e=document.querySelectorAll(`.tab-button`);for(let t of e)t.addEventListener(`click`,()=>{let e=t.getAttribute(`data-tab`);e&&y(e)});let t=document.querySelector(`.sidebar`);t&&t.addEventListener(`keydown`,e=>{let t=e,n=t.target;if(!n.classList.contains(`tab-button`))return;let r=n.closest(`.sidebar-section`);if(!r)return;let i=Array.from(r.querySelectorAll(`.tab-button`)),a=i.indexOf(n),o=-1;t.key===`ArrowDown`?o=a<i.length-1?a+1:0:t.key===`ArrowUp`?o=a>0?a-1:i.length-1:t.key===`Home`?o=0:t.key===`End`&&(o=i.length-1),o>=0&&(t.preventDefault(),i[o]?.focus())}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){let e=document.querySelector(`.modal.active`);e&&e.classList.remove(`active`)}})}async function ht(e,t=5,n=1e3){if(!Array.isArray(e))throw TypeError(`promiseFunctions must be an array`);let r=[];for(let i=0;i<e.length;i+=t){let a=e.slice(i,i+t).map(e=>typeof e==`function`?e():e),o=await Promise.allSettled(a);r.push(...o),i+t<e.length&&await new Promise(e=>setTimeout(e,n))}return r}async function gt(){let e=document.getElementById(`refresh-all-button`);if(!e||e.disabled)return;let t=e.textContent,n=e.disabled;try{e.textContent=`⏳ Refreshing All Tabs...`,e.disabled=!0,window.suppressErrorNotifications=!0,debugLog(`Refreshing all data for ALL tabs...`);let t=[];window.loadDashboard&&t.push(()=>window.loadDashboard()),window.loadADStatus&&t.push(()=>window.loadADStatus()),window.loadAnalytics&&t.push(()=>window.loadAnalytics()),window.loadExtensions&&t.push(()=>window.loadExtensions());let n=(await ht(t,5,1e3)).filter(e=>e.status===`rejected`);n.length>0&&debugLog(`${n.length} refresh operation(s) failed (expected for unavailable features):`,n.map(e=>e.reason?.message??e.reason)),_(`✅ All tabs refreshed successfully`,`success`)}catch(e){let t=e instanceof Error?e.message:String(e);console.error(`Error refreshing data:`,e),_(`Failed to refresh: ${t}`,`error`)}finally{window.suppressErrorNotifications=!1,e.textContent=t,e.disabled=n}}function _t(){let e=document.getElementById(`refresh-all-button`);e&&e.addEventListener(`click`,gt)}window.executeBatched=ht,window.refreshAllData=gt;var vt=6e4;async function yt(){try{let e=await h(`${p()}/api/status`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}: ${e.statusText}`);let t=await e.json();document.getElementById(`stat-extensions`).textContent=String(t.registered_extensions??0),document.getElementById(`stat-calls`).textContent=String(t.active_calls??0),document.getElementById(`stat-total-calls`).textContent=String(t.total_calls??0),document.getElementById(`stat-recordings`).textContent=String(t.active_recordings??0);let n=document.getElementById(`system-status`);n&&(n.textContent=`System: ${t.running?`Running`:`Stopped`}`,n.classList.remove(`connected`,`disconnected`),n.classList.add(`status-badge`,t.running?`connected`:`disconnected`)),b()}catch(e){console.error(`Error loading dashboard:`,e);for(let e of[`stat-extensions`,`stat-calls`,`stat-total-calls`,`stat-recordings`]){let t=document.getElementById(e);t&&(t.textContent=`Error`)}_(`Failed to load dashboard: ${e instanceof Error?e.message:String(e)}`,`error`)}}function bt(){yt(),_(`Dashboard refreshed`,`success`)}async function b(){try{let e=await h(`${p()}/api/integrations/ad/status`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}`);let t=await e.json(),n=document.getElementById(`ad-status-badge`);n&&(n.textContent=t.enabled?`Enabled`:`Disabled`,n.className=`status-badge ${t.enabled?`enabled`:`disabled`}`);let r=document.getElementById(`ad-connection-status`);r&&(r.textContent=t.connected?`✓ Connected`:`✗ Not Connected`,r.style.color=t.connected?`#10b981`:`#ef4444`);let i=e=>document.getElementById(e);i(`ad-server`)&&(i(`ad-server`).textContent=t.server??`Not configured`),i(`ad-auto-provision`)&&(i(`ad-auto-provision`).textContent=t.auto_provision?`Yes`:`No`),i(`ad-synced-users`)&&(i(`ad-synced-users`).textContent=String(t.synced_users??0));let a=i(`ad-error`);a&&(a.textContent=t.error??`None`,a.style.color=t.error?`#d32f2f`:`#10b981`);let o=i(`ad-sync-btn`);o&&(o.disabled=!(t.enabled&&t.connected))}catch(e){console.error(`Error loading AD status:`,e)}}function xt(){b(),_(`AD status refreshed`,`success`)}async function St(){let e=document.getElementById(`ad-sync-btn`);if(!e)return;let t=e.textContent;e.disabled=!0,e.textContent=`Syncing...`;try{let e=await h(`${p()}/api/integrations/ad/sync`,{method:`POST`,headers:m()},vt);if(!e.ok){let t=await e.json().catch(()=>({error:`HTTP ${e.status}`}));throw Error(t.error||`HTTP ${e.status}`)}let t=await e.json();t.success?(_(t.message||`Successfully synced ${t.synced_count} users`,`success`),b()):_(t.error||`Failed to sync users`,`error`)}catch(e){console.error(`Error syncing AD users:`,e),_((e instanceof Error?e.message:String(e))===`Request timed out`?`AD sync timed out. Check server logs.`:`Error syncing AD users`,`error`)}finally{e.textContent=t,e.disabled=!1}}window.loadDashboard=yt,window.refreshDashboard=bt,window.loadADStatus=b,window.refreshADStatus=xt,window.syncADUsers=St;var Ct=1e4;async function wt(){let e=document.getElementById(`extensions-table-body`);if(e){e.innerHTML=`<tr><td colspan="8" class="loading">Loading extensions...</td></tr>`;try{let t=await h(`${p()}/api/extensions`,{headers:m()},Ct);if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);let n=await t.json();if(window.currentExtensions=n,n.length===0){e.innerHTML=`<tr><td colspan="8" class="loading">No extensions found.</td></tr>`;return}let r=e=>{let t=``;return e.ad_synced&&(t+=` <span class="ad-badge" title="Synced from Active Directory">AD</span>`),e.is_admin&&(t+=` <span class="admin-badge" title="Admin Privileges">Admin</span>`),t};e.innerHTML=n.map(e=>`
        ...
        `).join(``)}catch(t){console.error(`Error loading extensions:`,t),e.innerHTML=`<tr><td colspan="8" class="loading">${(t instanceof Error?t.message:String(t))===`Request timed out`?`Request timed out. System may still be starting.`:`Error loading extensions`}</td></tr>`}}}function Tt(){let e=document.getElementById(`add-extension-modal`);e&&e.classList.add(`active`);let t=document.getElementById(`add-extension-form`);t&&t.reset()}function Et(){let e=document.getElementById(`add-extension-modal`);e&&e.classList.remove(`active`)}function Dt(e){let t=(window.currentExtensions??[]).find(t=>t.number===e);if(!t)return;let n=e=>document.getElementById(e);n(`edit-ext-number`)&&(n(`edit-ext-number`).value=t.number),n(`edit-ext-name`)&&(n(`edit-ext-name`).value=t.name),n(`edit-ext-email`)&&(n(`edit-ext-email`).value=t.email??``),n(`edit-ext-did-number`)&&(n(`edit-ext-did-number`).value=t.did_number??``),n(`edit-ext-allow-external`)&&(n(`edit-ext-allow-external`).checked=!!t.allow_external),n(`edit-ext-is-admin`)&&(n(`edit-ext-is-admin`).checked=!!t.is_admin),n(`edit-ext-password`)&&(n(`edit-ext-password`).value=``);let r=document.getElementById(`edit-extension-modal`);r&&r.classList.add(`active`)}function Ot(){let e=document.getElementById(`edit-extension-modal`);e&&e.classList.remove(`active`)}async function kt(e){if(confirm(`Are you sure you want to delete extension ${e}?`))try{let t=p(),n=await fetch(`${t}/api/extensions/${e}`,{method:`DELETE`,headers:m()});n.ok?(_(`Extension deleted successfully`,`success`),wt()):_((await n.json()).error||`Failed to delete extension`,`error`)}catch(e){console.error(`Error deleting extension:`,e),_(`Failed to delete extension`,`error`)}}async function At(e){if(confirm(`Reboot phone for extension ${e}?`))try{let t=p();(await fetch(`${t}/api/phones/${e}/reboot`,{method:`POST`,headers:m()})).ok?_(`Reboot command sent to ${e}`,`success`):_(`Failed to reboot phone`,`error`)}catch(e){console.error(`Error rebooting phone:`,e),_(`Failed to reboot phone`,`error`)}}async function jt(){if(confirm(`Reboot ALL registered phones?`))try{let e=p();(await fetch(`${e}/api/phones/reboot`,{method:`POST`,headers:m()})).ok?_(`Reboot command sent to all phones`,`success`):_(`Failed to reboot phones`,`error`)}catch(e){console.error(`Error rebooting all phones:`,e),_(`Failed to reboot phones`,`error`)}}function Mt(){let e=document.getElementById(`add-extension-form`);e&&e.addEventListener(`submit`,async e=>{e.preventDefault();let t=e=>document.getElementById(e)?.value??``,n=e=>document.getElementById(e)?.checked??!1,r={number:t(`new-ext-number`),name:t(`new-ext-name`),email:t(`new-ext-email`),password:t(`new-ext-password`),voicemail_pin:t(`new-ext-voicemail-pin`),did_number:t(`new-ext-did-number`),allow_external:n(`new-ext-allow-external`),is_admin:n(`new-ext-is-admin`)};try{let e=p(),t=await fetch(`${e}/api/extensions`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(r)}),n=await t.json();t.ok&&n.success?(_(`Extension added successfully`,`success`),Et(),wt()):_(n.error||`Failed to add extension`,`error`)}catch(e){console.error(`Error adding extension:`,e),_(`Failed to add extension`,`error`)}});let t=document.getElementById(`edit-extension-form`);t&&t.addEventListener(`submit`,async e=>{e.preventDefault();let t=e=>document.getElementById(e)?.value??``,n=e=>document.getElementById(e)?.checked??!1,r=t(`edit-ext-number`),i=t(`edit-ext-password`),a=t(`edit-ext-voicemail-pin`),o={name:t(`edit-ext-name`),email:t(`edit-ext-email`),did_number:t(`edit-ext-did-number`),allow_external:n(`edit-ext-allow-external`),is_admin:n(`edit-ext-is-admin`)};i&&(o.password=i),a&&(o.voicemail_pin=a);try{let e=p(),t=await fetch(`${e}/api/extensions/${r}`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(o)}),n=await t.json();t.ok&&n.success?(_(`Extension updated successfully`,`success`),Ot(),wt()):_(n.error||`Failed to update extension`,`error`)}catch(e){console.error(`Error updating extension:`,e),_(`Failed to update extension`,`error`)}})}window.loadExtensions=wt,window.showAddExtensionModal=Tt,window.closeAddExtensionModal=Et,window.editExtension=Dt,window.closeEditExtensionModal=Ot,window.deleteExtension=kt,window.rebootPhone=At,window.rebootAllPhones=jt,document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Mt):Mt();async function Nt(){try{let e=p(),t=await fetch(`${e}/api/extensions`,{headers:m()});if(!t.ok)throw Error(`HTTP error! status: ${t.status}`);let n=await t.json(),r=document.getElementById(`vm-extension-select`);if(!r)return;r.innerHTML=`<option value="">Select Extension</option>`;for(let e of n){let t=document.createElement(`option`);t.value=e.number,t.textContent=`${e.number} - ${e.name}`,r.appendChild(t)}}catch(e){console.error(`Error loading voicemail tab:`,e),_(`Failed to load extensions`,`error`)}}async function Pt(){let e=document.getElementById(`vm-extension-select`)?.value;if(!e){for(let e of[`voicemail-pin-section`,`voicemail-messages-section`,`voicemail-box-overview`]){let t=document.getElementById(e);t&&(t.style.display=`none`)}return}for(let e of[`voicemail-pin-section`,`voicemail-messages-section`,`voicemail-box-overview`]){let t=document.getElementById(e);t&&(t.style.display=`block`)}let t=document.getElementById(`vm-current-extension`);t&&(t.textContent=e);try{let t=p(),n=await fetch(`${t}/api/voicemail/${e}`,{headers:m()});if(!n.ok)throw Error(`HTTP error! status: ${n.status}`);Ft((await n.json()).messages,e)}catch(e){console.error(`Error loading voicemail:`,e),_(`Failed to load voicemail messages`,`error`)}}function Ft(e,t){let n=document.getElementById(`voicemail-cards-view`);if(n){if(!e||e.length===0){n.innerHTML=`<div class="info-box">No voicemail messages</div>`;return}n.innerHTML=e.map(e=>{let n=new Date(e.timestamp).toLocaleString(),r=e.duration?`${e.duration}s`:`Unknown`,i=!e.listened;return`
        ...
        `}).join(``)}}async function It(e,t){try{let n=`${p()}/api/voicemail/${e}/${t}/audio`,r=document.getElementById(`vm-audio-player`);r&&(r.src=n,r.play()),await Rt(e,t)}catch(e){console.error(`Error playing voicemail:`,e),_(`Failed to play voicemail`,`error`)}}async function Lt(e,t){let n=p();window.open(`${n}/api/voicemail/${e}/${t}/audio?download=1`,`_blank`)}async function Rt(e,t){try{let n=p();await fetch(`${n}/api/voicemail/${e}/${t}/read`,{method:`POST`,headers:m()})}catch(e){console.error(`Error marking voicemail read:`,e)}}async function zt(e,t){if(confirm(`Delete this voicemail message?`))try{let n=p();(await fetch(`${n}/api/voicemail/${e}/${t}`,{method:`DELETE`,headers:m()})).ok?(_(`Voicemail deleted`,`success`),Pt()):_(`Failed to delete voicemail`,`error`)}catch(e){console.error(`Error deleting voicemail:`,e),_(`Failed to delete voicemail`,`error`)}}function Bt(){let e=document.getElementById(`vm-audio-player`);e&&(e.pause(),e.src=``);let t=document.getElementById(`voicemail-player-section`);t&&(t.style.display=`none`)}function Vt(){let e=document.getElementById(`voicemail-cards-view`),t=document.getElementById(`voicemail-table-view`),n=document.getElementById(`toggle-voicemail-view-btn`);if(e&&t){let r=e.style.display!==`none`;e.style.display=r?`none`:`block`,t.style.display=r?`block`:`none`,n&&(n.textContent=r?`Switch to Card View`:`Switch to Table View`)}}window.loadVoicemailTab=Nt,window.loadVoicemailForExtension=Pt,window.playVoicemail=It,window.downloadVoicemail=Lt,window.deleteVoicemail=zt,window.markVoicemailRead=Rt,window.closeVoicemailPlayer=Bt,window.toggleVoicemailView=Vt;async function Ht(){let e=document.getElementById(`calls-list`);if(e){e.innerHTML=`<div class="loading">Loading calls...</div>`;try{let t=await(await h(`${p()}/api/calls`,{headers:m()})).json();if(t.length===0){e.innerHTML=`<div class="loading">No active calls</div>`;return}e.innerHTML=t.map(e=>`
            <div class="call-item"><strong>Call:</strong> ${g(String(e))}</div>
        `).join(``)}catch(t){console.error(`Error loading calls:`,t),e.innerHTML=`<div class="loading">Error loading calls</div>`}}}async function Ut(){try{let e=await h(`${p()}/api/config/codecs`,{headers:m()});if(!e.ok)throw Error(`Failed to load codecs (HTTP ${e.status})`);let t=await e.json(),n=document.getElementById(`codec-status`);n&&(t.codecs&&t.codecs.length>0?n.innerHTML=t.codecs.map(e=>`<div class="codec-item">${g(e.name)} - <span class="status-${e.enabled?`enabled`:`disabled`}">${e.enabled?`Enabled`:`Disabled`}</span></div>`).join(``):n.innerHTML=`<div class="info-box">No codecs configured</div>`)}catch(e){console.error(`Error loading codec status:`,e);let t=document.getElementById(`codec-status`);t&&(t.innerHTML=`<div class="error-box">Failed to load codec configuration</div>`)}}async function Wt(){try{let e=await h(`${p()}/api/config/dtmf`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}`);let t=await e.json(),n=document.getElementById(`dtmf-mode`);n&&(n.value=t.mode??`rfc2833`);let r=document.getElementById(`dtmf-detection-threshold`);r&&(r.value=String(t.threshold??-30))}catch(e){console.error(`Error loading DTMF config:`,e)}}async function Gt(){try{let e=p(),t={mode:document.getElementById(`dtmf-mode`)?.value??`rfc2833`,threshold:parseInt(document.getElementById(`dtmf-detection-threshold`)?.value??`-30`)};(await fetch(`${e}/api/config/dtmf`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(t)})).ok?_(`DTMF configuration saved`,`success`):_(`Failed to save DTMF configuration`,`error`)}catch(e){console.error(`Error saving DTMF config:`,e),_(`Failed to save DTMF configuration`,`error`)}}async function Kt(e){e&&e.preventDefault();try{let e=p(),t=document.getElementById(`codec-config-form`);if(!t)return;let n=new FormData(t),r=Object.fromEntries(n.entries());(await fetch(`${e}/api/config/codecs`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(r)})).ok?_(`Codec configuration saved`,`success`):_(`Failed to save codec configuration`,`error`)}catch(e){console.error(`Error saving codec config:`,e),_(`Failed to save codec configuration`,`error`)}}window.loadCalls=Ht,window.loadCodecStatus=Ut,window.loadDTMFConfig=Wt,window.saveDTMFConfig=Gt,window.saveCodecConfig=Kt;var qt=`Configuration saved successfully. Restart may be required for some changes.`;async function Jt(){try{let e=await h(`${p()}/api/config/full`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}`);let t=await e.json();if(t.features)for(let e of[`call-recording`,`call-transfer`,`call-hold`,`conference`,`voicemail`,`call-parking`,`call-queues`,`presence`,`music-on-hold`,`auto-attendant`]){let n=document.getElementById(`feature-${e}`),r=e.replace(/-/g,`_`);n&&(n.checked=t.features[r]??!1)}if(t.voicemail){let e=e=>document.getElementById(e);e(`voicemail-max-duration`)&&(e(`voicemail-max-duration`).value=String(t.voicemail.max_duration??120))}}catch(e){console.error(`Error loading config:`,e),_(`Failed to load configuration`,`error`)}}async function Yt(){try{let e=await h(`${p()}/api/config/features`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}`);let t=await e.json();Xt(`core-features-table`,t.core),Xt(`advanced-features-table`,t.advanced),Xt(`integration-features-table`,t.integrations)}catch(e){console.error(`Error loading features status:`,e),_(`Failed to load feature status`,`error`)}}function Xt(e,t){let n=document.getElementById(e);if(n){if(!t||Object.keys(t).length===0){n.innerHTML=`<tr><td colspan="3" style="text-align:center;">No features found</td></tr>`;return}n.innerHTML=Object.entries(t).map(([e,t])=>{let n=e.replace(/_/g,` `).replace(/\b\w/g,e=>e.toUpperCase()),r=t.enabled?`<span class="badge" style="background:#10b981;">Enabled</span>`:`<span class="badge" style="background:#6b7280;">Disabled</span>`;return`<tr>
            <td><strong>${g(n)}</strong></td>
            <td>${r}</td>
            <td>${g(t.description)}</td>
        </tr>`}).join(``)}}async function Zt(e){try{let t=p(),n=document.getElementById(`${e}-form`);if(!n)return;let r=new FormData(n),i=Object.fromEntries(r.entries()),a=await fetch(`${t}/api/config/section`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({section:e,data:i})});a.ok?_(qt,`success`):_((await a.json()).error||`Failed to save configuration`,`error`)}catch(t){console.error(`Error saving ${e} config:`,t),_(`Failed to save ${e} configuration`,`error`)}}async function Qt(){try{let e=await h(`${p()}/api/ssl/status`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}`);let t=await e.json(),n=document.getElementById(`ssl-status-info`);if(n&&(n.textContent=t.enabled?`Enabled`:`Disabled`,n.className=`status-badge ${t.enabled?`enabled`:`disabled`}`),t.certificate){let e=document.getElementById(`cert-details-section`);e&&(e.style.display=`block`);let n=document.getElementById(`cert-subject`),r=document.getElementById(`cert-issuer`),i=document.getElementById(`cert-valid-from`),a=document.getElementById(`cert-valid-until`);n&&(n.value=t.certificate.subject||`N/A`),r&&(r.value=t.certificate.issuer||`N/A`),i&&(i.value=t.certificate.expires||`N/A`),a&&(a.value=t.certificate.expires||`N/A`)}}catch(e){console.error(`Error loading SSL status:`,e)}}async function $t(){try{let e=p(),t=await fetch(`${e}/api/ssl/generate-certificate`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({})});t.ok?(_(`SSL certificate generated successfully. Server restart required.`,`success`),Qt()):_((await t.json()).error||`Failed to generate SSL certificate`,`error`)}catch(e){console.error(`Error generating SSL certificate:`,e),_(`Failed to generate SSL certificate`,`error`)}}async function en(){await Qt(),_(`SSL status refreshed`,`success`)}var tn=[`features-config`,`voicemail-config`,`email-config`,`recording-config`,`security-config`,`advanced-features`,`conference-config`,`ssl-config`];function nn(){for(let e of tn){let t=document.getElementById(`${e}-form`);t&&t.addEventListener(`submit`,async t=>{t.preventDefault(),await Zt(e)})}}window.loadConfig=Jt,window.loadFeaturesStatus=Yt,window.saveConfigSection=Zt,window.loadSSLStatus=Qt,window.generateSSLCertificate=$t,window.refreshSSLStatus=en,document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,nn):nn();var rn=[],x={};async function an(){await Promise.all([on(),sn(),S(),cn(),ln(),un()])}async function on(){try{let e=p(),t=await fetch(`${e}/api/provisioning/vendors`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();rn=n.vendors||[],x=n.models||{},fn(),pn()}catch(e){console.error(`Error loading vendors:`,e);let t=document.getElementById(`supported-vendors-list`);t&&(t.innerHTML=`<p>Failed to load supported vendors.</p>`)}}async function sn(){try{let e=p(),t=await fetch(`${e}/api/extensions`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`device-extension`);if(!r)return;r.innerHTML=`<option value="">Select Extension</option>`;for(let e of n){let t=document.createElement(`option`);t.value=e.number,t.textContent=`${e.number} - ${e.name}`,r.appendChild(t)}}catch(e){console.error(`Error loading extensions for provisioning:`,e)}}async function S(){try{let e=p(),t=await fetch(`${e}/api/provisioning/devices`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`provisioning-devices-table-body`);if(!r)return;let i=Array.isArray(n)?n:n.devices||[];if(i.length===0){r.innerHTML=`<tr><td colspan="8">No provisioned devices</td></tr>`;return}r.innerHTML=i.map(e=>`
            <tr>
        ...
        `).join(``)}catch(e){console.error(`Error loading devices:`,e)}}async function cn(){try{let e=p(),t=await fetch(`${e}/api/provisioning/templates`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`templates-table-body`);if(!r)return;let i=n.templates||[];if(i.length===0){r.innerHTML=`<tr><td colspan="5">No templates configured</td></tr>`;return}r.innerHTML=i.map(e=>{let t=e.name||`${e.vendor||`unknown`}_${e.model||`unknown`}`;return`
            ...
            </tr>`}).join(``)}catch(e){console.error(`Error loading templates:`,e)}}async function ln(){try{let e=p(),t=await fetch(`${e}/api/provisioning/settings`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=e=>document.getElementById(e);r(`provisioning-enabled`)&&(r(`provisioning-enabled`).checked=n.enabled??!1),r(`provisioning-url-format`)&&(r(`provisioning-url-format`).value=n.url_format??``),hn()}catch(e){console.error(`Error loading provisioning settings:`,e)}}async function un(){try{let e=p(),t=await fetch(`${e}/api/provisioning/phonebook-settings`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=e=>document.getElementById(e);r(`ldap-phonebook-enabled`)&&(r(`ldap-phonebook-enabled`).checked=n.ldap_enabled??!1),r(`remote-phonebook-enabled`)&&(r(`remote-phonebook-enabled`).checked=n.remote_enabled??!1),_n(),vn()}catch(e){console.error(`Error loading phonebook settings:`,e)}}async function dn(e){if(confirm(`Delete device ${e}?`))try{let t=p();(await fetch(`${t}/api/provisioning/devices/${e}`,{method:`DELETE`,headers:m()})).ok?(_(`Device deleted`,`success`),S()):_(`Failed to delete device`,`error`)}catch(e){console.error(`Error deleting device:`,e),_(`Failed to delete device`,`error`)}}function fn(){let e=document.getElementById(`device-vendor`);if(e){e.innerHTML=`<option value="">Select Vendor</option>`;for(let t of rn){let n=document.createElement(`option`);n.value=t,n.textContent=t,e.appendChild(n)}}}function pn(){let e=document.getElementById(`supported-vendors-list`);if(e){if(rn.length===0){e.innerHTML=`<p>No supported vendors found.</p>`;return}e.innerHTML=rn.map(e=>{let t=x[e]||x[e.toLowerCase()]||[],n=t.length>0?t.map(e=>`<span class="badge">${g(e.toUpperCase())}</span>`).join(` `):`<em>No models</em>`;return`<div style="margin-bottom: 8px;">
            <strong>${g(e.charAt(0).toUpperCase()+e.slice(1))}</strong>: ${n}
        </div>`}).join(``)}}function mn(){let e=document.getElementById(`device-vendor`),t=document.getElementById(`device-model`);if(!e||!t)return;let n=e.value;if(t.innerHTML=``,!n){t.innerHTML=`<option value="">Select Vendor First</option>`;return}let r=x[n]||x[n.toLowerCase()]||[];if(r.length===0){t.innerHTML=`<option value="">No models available</option>`;return}t.innerHTML=`<option value="">Select Model</option>`;for(let e of r){let n=document.createElement(`option`);n.value=e,n.textContent=e,t.appendChild(n)}}function hn(){let e=document.getElementById(`provisioning-enabled`),t=document.getElementById(`provisioning-settings`);e&&t&&(t.style.display=e.checked?`block`:`none`)}async function gn(){try{let e=e=>document.getElementById(e)?.value??``,t={enabled:(e=>document.getElementById(e)?.checked??!1)(`provisioning-enabled`),server_ip:e(`provisioning-server-ip`),port:parseInt(e(`provisioning-port`),10)||9e3,custom_templates_dir:e(`provisioning-custom-dir`)},n=p();(await fetch(`${n}/api/provisioning/settings`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(t)})).ok?_(`Provisioning settings saved`,`success`):_(`Failed to save provisioning settings`,`error`)}catch(e){console.error(`Error saving provisioning settings:`,e),_(`Failed to save provisioning settings`,`error`)}}function _n(){let e=document.getElementById(`ldap-phonebook-enabled`),t=document.getElementById(`ldap-phonebook-settings`);e&&t&&(t.style.display=e.checked?`block`:`none`)}function vn(){let e=document.getElementById(`remote-phonebook-enabled`),t=document.getElementById(`remote-phonebook-settings`);e&&t&&(t.style.display=e.checked?`block`:`none`)}async function yn(){try{let e=e=>document.getElementById(e)?.value??``,t=e=>document.getElementById(e)?.checked??!1,n={ldap_enabled:t(`ldap-phonebook-enabled`),ldap_server:e(`ldap-phonebook-server`),ldap_port:parseInt(e(`ldap-phonebook-port`),10)||636,ldap_base_dn:e(`ldap-phonebook-base`),ldap_bind_user:e(`ldap-phonebook-user`),ldap_bind_password:e(`ldap-phonebook-password`),ldap_use_tls:t(`ldap-phonebook-tls`),ldap_display_name:e(`ldap-phonebook-display-name`),remote_enabled:t(`remote-phonebook-enabled`),remote_refresh_interval:parseInt(e(`remote-phonebook-refresh`),10)||60},r=p();(await fetch(`${r}/api/provisioning/phonebook-settings`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(n)})).ok?_(`Phone book settings saved`,`success`):_(`Failed to save phone book settings`,`error`)}catch(e){console.error(`Error saving phonebook settings:`,e),_(`Failed to save phone book settings`,`error`)}}async function bn(){try{let e=p();(await fetch(`${e}/api/provisioning/reload-templates`,{method:`POST`,headers:m()})).ok?(_(`Templates reloaded from disk`,`success`),cn()):_(`Failed to reload templates`,`error`)}catch(e){console.error(`Error reloading templates:`,e),_(`Failed to reload templates`,`error`)}}function xn(){let e=document.getElementById(`add-device-form`);e&&e.reset();let t=document.getElementById(`device-model`);t&&(t.innerHTML=`<option value="">Select Vendor First</option>`)}function Sn(e){_(`Viewing template: ${e}`,`info`)}function Cn(){let e=document.getElementById(`add-device-form`);e&&e.addEventListener(`submit`,async e=>{e.preventDefault();let t=e=>document.getElementById(e)?.value??``,n={mac_address:t(`device-mac`),extension_number:t(`device-extension`),vendor:t(`device-vendor`),model:t(`device-model`)};if(!n.mac_address||!n.extension_number||!n.vendor||!n.model){_(`Please fill in all required fields`,`error`);return}try{let e=p(),t=await fetch(`${e}/api/provisioning/devices`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(n)}),r=await t.json();t.ok&&r.success?(_(r.message||`Device added successfully`,`success`),xn(),S()):_(r.error||`Failed to add device`,`error`)}catch(e){console.error(`Error adding device:`,e),_(`Failed to add device`,`error`)}})}window.loadProvisioning=an,window.loadSupportedVendors=on,window.loadProvisioningDevices=S,window.loadProvisioningTemplates=cn,window.loadProvisioningSettings=ln,window.loadPhonebookSettings=un,window.deleteDevice=dn,window.viewTemplate=Sn,window.updateModelOptions=mn,window.toggleProvisioningEnabled=hn,window.saveProvisioningSettings=gn,window.toggleLdapPhonebookSettings=_n,window.toggleRemotePhonebookSettings=vn,window.savePhonebookSettings=yn,window.reloadTemplates=bn,window.resetAddDeviceForm=xn,document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,Cn):Cn();async function wn(){let e=document.getElementById(`registered-phones-table-body`);if(e)try{let t=await h(`${p()}/api/registered-phones`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(n.length===0){e.innerHTML=`<tr><td colspan="5">No registered phones</td></tr>`;return}e.innerHTML=n.map(e=>`
            <tr>
        ...
        `).join(``)}catch(t){console.error(`Error loading registered phones:`,t),e.innerHTML=`<tr><td colspan="5">Error loading phones</td></tr>`}}async function Tn(){let e=document.getElementById(`registered-atas-table-body`);if(e)try{let t=await h(`${p()}/api/registered-phones/atas`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(n.length===0){e.innerHTML=`<tr><td colspan="6">No registered ATAs</td></tr>`;return}e.innerHTML=n.map(e=>{let t=[e.vendor,e.model].filter(Boolean).join(` `);return`
            <tr>
                <td>${g(e.extension_number||``)}</td>
                <td>${g(e.ip_address||``)}</td>
                <td>${g(e.mac_address||``)}</td>
        ...
        `}).join(``)}catch(t){console.error(`Error loading ATAs:`,t),e.innerHTML=`<tr><td colspan="6">Error loading ATAs</td></tr>`}}window.loadRegisteredPhones=wn,window.loadRegisteredATAs=Tn;async function En(){try{let e=p(),t=await fetch(`${e}/api/fraud-detection/alerts`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`fraud-alerts-list`);if(!r)return;let i=n.alerts??[];if(i.length===0){r.innerHTML=`<div class="info-box">No fraud alerts</div>`;return}r.innerHTML=i.map(e=>`
        ...
        `).join(``)}catch(e){console.error(`Error loading fraud alerts:`,e)}}async function Dn(){try{let e=p(),t=await fetch(`${e}/api/callback-queue/list`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`callback-list`);if(!r)return;let i=n.queue??[];if(i.length===0){r.innerHTML=`<tr><td colspan="5">No callbacks in queue</td></tr>`;return}r.innerHTML=i.map(e=>`
            <tr>
                <td>${g(e.caller||``)}</td>
                <td>${g(e.number||``)}</td>
                <td>${g(e.status||``)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading callback queue:`,e)}}async function On(e){try{let t=p();(await fetch(`${t}/api/callback-queue/start`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({callback_id:e,agent_id:`admin`})})).ok?(_(`Callback initiated`,`success`),Dn()):_(`Failed to start callback`,`error`)}catch(e){console.error(`Error starting callback:`,e),_(`Failed to start callback`,`error`)}}async function kn(e){try{let t=p();(await fetch(`${t}/api/callback-queue/cancel`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({callback_id:e})})).ok?(_(`Callback cancelled`,`success`),Dn()):_(`Failed to cancel callback`,`error`)}catch(e){console.error(`Error cancelling callback:`,e),_(`Failed to cancel callback`,`error`)}}async function An(){try{let e=p(),t=await fetch(`${e}/api/mobile-push/devices`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`mobile-devices-list`);if(!r)return;let i=n.devices??[];if(i.length===0){r.innerHTML=`<div class="info-box">No registered devices</div>`;return}r.innerHTML=i.map(e=>`
        ...
        `).join(``)}catch(e){console.error(`Error loading mobile push devices:`,e)}}async function jn(){try{let e=p(),t=await fetch(`${e}/api/framework/speech-analytics/configs`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=document.getElementById(`speech-analytics-configs-table`);if(r){let e=n.configs??[];e.length===0?r.innerHTML=`<div class="info-box">No speech analytics configurations</div>`:r.innerHTML=`
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Configuration</th>
                ...
                `}}catch(e){console.error(`Error loading speech analytics:`,e)}}window.loadFraudAlerts=En,window.loadCallbackQueue=Dn,window.startCallback=On,window.cancelCallback=kn,window.loadMobilePushDevices=An,window.loadSpeechAnalyticsConfigs=jn;async function Mn(){try{let e=p(),t=await fetch(`${e}/api/emergency/contacts`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`emergency-contacts-table`);if(!r)return;let i=n.contacts??[];if(i.length===0){r.innerHTML=`<tr><td colspan="5">No emergency contacts</td></tr>`;return}r.innerHTML=i.map(e=>`
            <tr>
                <td>${g(e.name||``)}</td>
                <td>${g(e.phone||``)}</td>
                <td>${g(e.role||``)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading emergency contacts:`,e)}}function Nn(e){return`<span class="status-badge ${{high:`danger`,medium:`warning`,low:`info`}[e??``]??`info`}">${e??`normal`}</span>`}async function Pn(){try{let e=p(),t=await fetch(`${e}/api/emergency/history`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=document.getElementById(`emergency-history-table`);if(!r)return;let i=n.history??[];r.innerHTML=i.length===0?`<div class="info-box">No emergency history</div>`:i.map(e=>`
                <div class="history-item">
                    <strong>${new Date(e.timestamp).toLocaleString()}</strong> - ${g(e.description||``)}
                </div>
            `).join(``)}catch(e){console.error(`Error loading emergency history:`,e)}}async function Fn(e){if(confirm(`Delete this emergency contact?`))try{let t=p();(await fetch(`${t}/api/emergency/contacts/${e}`,{method:`DELETE`,headers:m()})).ok&&(_(`Emergency contact deleted`,`success`),Mn())}catch(e){console.error(`Error deleting contact:`,e),_(`Failed to delete contact`,`error`)}}async function In(){try{let e=p(),t=await fetch(`${e}/api/framework/nomadic-e911/sites`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`e911-sites-table`);if(!r)return;let i=n.sites??[];r.innerHTML=i.length===0?`<div class="info-box">No E911 sites configured</div>`:i.map(e=>`
                <div class="site-item">
            ...
            `).join(``)}catch(e){console.error(`Error loading E911 sites:`,e);let t=document.getElementById(`e911-sites-table`);t&&(t.innerHTML=`<div class="error-box">Failed to load E911 sites</div>`)}}async function Ln(){try{let e=p(),t=await fetch(`${e}/api/framework/nomadic-e911/locations`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`extension-locations-table`);if(r){let e=n.locations??[];r.innerHTML=e.length===0?`<div class="info-box">No locations assigned</div>`:e.map(e=>`
                    <div class="location-item">
                        Extension ${g(e.extension)} - ${g(e.site_name||`Unassigned`)}
                    </div>
                `).join(``)}}catch(e){console.error(`Error loading extension locations:`,e)}}function Rn(){let e=document.getElementById(`add-emergency-contact-modal`);e&&e.classList.add(`active`)}function zn(){let e=document.getElementById(`add-emergency-contact-modal`);e&&e.classList.remove(`active`)}function Bn(){let e=document.getElementById(`trigger-emergency-modal`);e&&e.classList.add(`active`)}function Vn(){let e=document.getElementById(`trigger-emergency-modal`);e&&e.classList.remove(`active`)}async function Hn(e){e.preventDefault();let t=e=>document.getElementById(e)?.value??``,n=e=>document.getElementById(e)?.checked??!1,r=[];n(`method-call`)&&r.push(`call`),n(`method-page`)&&r.push(`page`),n(`method-email`)&&r.push(`email`),n(`method-sms`)&&r.push(`sms`);let i={name:t(`emergency-contact-name`),extension:t(`emergency-contact-extension`),phone:t(`emergency-contact-phone`),email:t(`emergency-contact-email`),priority:t(`emergency-contact-priority`),notification_methods:r};try{let e=p();(await fetch(`${e}/api/emergency/contacts`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(i)})).ok?(_(`Emergency contact added`,`success`),zn(),Mn()):_(`Failed to add emergency contact`,`error`)}catch(e){console.error(`Error adding emergency contact:`,e),_(`Failed to add emergency contact`,`error`)}}async function Un(e){e.preventDefault();let t=e=>document.getElementById(e)?.value??``,n={type:t(`trigger-type`),details:t(`trigger-details`),info:t(`trigger-info`)};try{let e=p();(await fetch(`${e}/api/emergency/trigger`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(n)})).ok?(_(`Emergency notification sent`,`success`),Vn(),Pn()):_(`Failed to trigger emergency`,`error`)}catch(e){console.error(`Error triggering emergency:`,e),_(`Failed to trigger emergency`,`error`)}}async function Wn(){try{let e=p();(await fetch(`${e}/api/emergency/test`,{method:`GET`,headers:m()})).ok?_(`Test notification sent successfully`,`success`):_(`Failed to send test notification`,`error`)}catch(e){console.error(`Error testing emergency notification:`,e),_(`Failed to send test notification`,`error`)}}window.loadEmergencyContacts=Mn,window.loadEmergencyHistory=Pn,window.deleteEmergencyContact=Fn,window.loadE911Sites=In,window.loadExtensionLocations=Ln,window.showAddEmergencyContactModal=Rn,window.closeAddEmergencyContactModal=zn,window.showTriggerEmergencyModal=Bn,window.closeTriggerEmergencyModal=Vn,window.addEmergencyContact=Hn,window.triggerEmergency=Un,window.testEmergencyNotification=Wn;async function Gn(){try{let e=p(),t=await fetch(`${e}/api/phone-book`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`phone-book-body`);if(!r)return;let i=n.entries??[];if(i.length===0){r.innerHTML=`<tr><td colspan="5">No phone book entries</td></tr>`;return}r.innerHTML=i.map(e=>`
            <tr>
                <td>${g(e.name||``)}</td>
                <td>${g(e.number||``)}</td>
                <td>${g(e.email||``)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading phone book:`,e)}}async function Kn(e){if(confirm(`Delete this phone book entry?`))try{let t=p();(await fetch(`${t}/api/phone-book/${e}`,{method:`DELETE`,headers:m()})).ok&&(_(`Phone book entry deleted`,`success`),Gn())}catch(e){console.error(`Error deleting entry:`,e),_(`Failed to delete entry`,`error`)}}window.loadPhoneBook=Gn,window.deletePhoneBookEntry=Kn;async function qn(){await Promise.all([C(),Jn(),Yn()])}async function C(){try{let e=p(),t=await fetch(`${e}/api/paging/zones`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=document.getElementById(`paging-zones-table-body`);if(!r)return;let i=n.zones??[];if(i.length===0){r.innerHTML=`<tr><td colspan="4">No paging zones</td></tr>`;return}r.innerHTML=i.map(e=>`
            <tr>
                <td>${g(e.name||``)}</td>
                <td>${g(e.number||``)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading paging zones:`,e)}}async function Jn(){try{let e=p(),t=await fetch(`${e}/api/paging/devices`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=document.getElementById(`paging-devices-table-body`);if(r){let e=n.devices??[];r.innerHTML=e.length===0?`<div class="info-box">No paging devices</div>`:e.map(e=>`<div class="device-item">${g(e.name||e.id)}</div>`).join(``)}}catch(e){console.error(`Error loading paging devices:`,e)}}async function Yn(){try{let e=p(),t=await fetch(`${e}/api/paging/active`,{headers:m()});if(!t.ok)return;let n=await t.json(),r=document.getElementById(`active-pages-table-body`);if(r){let e=n.pages??[];r.innerHTML=e.length===0?`<div class="info-box">No active pages</div>`:e.map(e=>`<div class="page-item">${g(e.zone)} - ${g(e.initiator)}</div>`).join(``)}}catch(e){console.error(`Error loading active pages:`,e)}}async function Xn(e){if(confirm(`Delete this paging zone?`))try{let t=p();(await fetch(`${t}/api/paging/zones/${e}`,{method:`DELETE`,headers:m()})).ok&&(_(`Paging zone deleted`,`success`),C())}catch(e){console.error(`Error deleting paging zone:`,e),_(`Failed to delete zone`,`error`)}}function Zn(){document.getElementById(`paging-zone-modal`)?.remove()}function Qn(){Zn(),document.body.insertAdjacentHTML(`beforeend`,`
    ...
    `);let e=document.getElementById(`paging-zone-form`);e.onsubmit=e=>{e.preventDefault(),$n()}}async function $n(){let e=document.getElementById(`zone-extension`).value.trim(),t=document.getElementById(`zone-name`).value.trim(),n=document.getElementById(`zone-description`).value.trim(),r=document.getElementById(`zone-device-id`).value.trim();if(!e||!t)return;let i={extension:e,name:t,description:n,device_id:r};try{let e=p(),n=await(await fetch(`${e}/api/paging/zones`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(i)})).json();n.success?(_(`Zone ${t} added successfully`,`success`),Zn(),C()):_(n.message??`Failed to add zone`,`error`)}catch(e){console.error(`Error adding zone ${t}:`,e),_(`Error adding zone ${t}`,`error`)}}function er(){document.getElementById(`paging-device-modal`)?.remove()}function tr(){er(),document.body.insertAdjacentHTML(`beforeend`,`
    ...
    `);let e=document.getElementById(`paging-device-form`);e.onsubmit=e=>{e.preventDefault(),nr()}}async function nr(){let e=document.getElementById(`device-id`).value.trim(),t=document.getElementById(`device-name`).value.trim(),n=document.getElementById(`device-type`).value.trim()||`sip_gateway`,r=document.getElementById(`device-sip-address`).value.trim();if(!e||!t)return;let i={device_id:e,name:t,type:n,sip_address:r};try{let e=p(),n=await(await fetch(`${e}/api/paging/devices`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(i)})).json();n.success?(_(`Device ${t} added successfully`,`success`),er(),Jn()):_(n.message??`Failed to add device`,`error`)}catch(e){console.error(`Error adding device ${t}:`,e),_(`Error adding device ${t}`,`error`)}}async function rr(e){if(confirm(`Delete paging device ${e}?`))try{let t=p(),n=await(await fetch(`${t}/api/paging/devices/${e}`,{method:`DELETE`,headers:m()})).json();n.success?(_(`Device ${e} deleted`,`success`),Jn()):_(n.message??`Failed to delete device`,`error`)}catch(e){console.error(`Error deleting device:`,e),_(`Error deleting device`,`error`)}}window.loadPagingData=qn,window.loadPagingZones=C,window.loadPagingDevices=Jn,window.loadActivePages=Yn,window.deletePagingZone=Xn,window.showAddZoneModal=Qn,window.closeZoneModal=Zn,window.showAddDeviceModal=tr,window.closeDeviceModal=er,window.deletePagingDevice=rr;var ir={"log-in":`<path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/>`,"log-out":`<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>`,pause:`<rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/>`,play:`<polygon points="6 3 20 12 6 21 6 3"/>`,pencil:`<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z"/><path d="m15 5 4 4"/>`,"user-plus":`<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>`,trash:`<polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/>`},ar=new Set([`play`]);function w(e){let t=ir[e]??``;return`<svg class="icon" viewBox="0 0 24 24" fill="${ar.has(e)?`currentColor`:`none`}" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${t}</svg>`}var or=[`round_robin`,`least_recent`,`fewest_calls`,`random`],sr=[],cr=new Map,T=new Set;async function E(){await Promise.all([dr(),fr()]),_r()}async function lr(){await dr(),_r()}async function ur(){await fr(),_r()}async function dr(){try{let e=p(),t=await fetch(`${e}/api/queues`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);sr=(await t.json()).queues??[]}catch(e){console.error(`Error loading queues:`,e)}}async function fr(){try{let e=p(),t=await fetch(`${e}/api/queues/agents/state`,{headers:m()});if(!t.ok)return;let n=await t.json();cr=new Map((n.agents??[]).map(e=>[e.extension,e]))}catch(e){console.error(`Error loading queue agents:`,e)}}function pr(e){let t=e?.logged_in??!1,n=e?.paused??!1,r,i,a;return t?n?(r=`warn`,i=`Paused`,a=e?.pause_reason?`Paused (${e.pause_reason})`:`Paused`):(r=`ok`,i=`Available`,a=`Available`):(r=`off`,i=`Logged out`,a=`Logged out`),`<span class="status-pill ${r}" title="${g(a)}"><span class="status-dot"></span>${i}</span>`}function mr(e,t){let n=cr.get(t),r=n?.logged_in??!1,i=n?.paused??!1,a=n?.calls_taken??0,o=n?.consecutive_misses??0,s=n?.last_call_time?g(new Date(n.last_call_time).toLocaleString()):`—`,c=g(t),l=g(e),u=r?`Log out`:`Log in`,ee=`<button type="button" class="${r?`icon-btn`:`icon-btn icon-btn-on`}" title="${u}" aria-label="${u}" onclick="setQueueAgentState('${c}', {logged_in: ${!r}})">${w(r?`log-out`:`log-in`)}</button>`,te=i?`Resume`:`Pause`,ne=r?`<button type="button" class="icon-btn" title="${te}" aria-label="${te}" onclick="setQueueAgentState('${c}', {paused: ${!i}})">${w(i?`play`:`pause`)}</button>`:`<button type="button" class="icon-btn" title="Log in to pause" aria-label="Pause (log in first)" disabled>${w(`pause`)}</button>`,re=`<button type="button" class="icon-btn icon-btn-danger" title="Remove from queue" aria-label="Remove from queue" onclick="removeQueueAgent('${l}', '${c}')">${w(`trash`)}</button>`;return`
        <tr class="queue-agent-row">
            ...
            <td>${s}</td>
            <td>
                <div class="agent-actions">${ee}${ne}${re}</div>
            </td>
        </tr>
    `}function hr(e){let t=g(e.queue_number),n=T.has(e.queue_number),r=`${e.calls_waiting}${e.calls_waiting>0?` (${Math.round(e.longest_wait)}s)`:``}`,i=`
        <div class="queue-card-head">
            ...
            <span class="qch-stats">
                ...
                <span class="qch-stat"><span class="k">Overflow</span><span class="v">${g(e.fallback_mailbox)}</span></span>
            </span>
    ...
    `}function gr(e){T.has(e)?T.delete(e):T.add(e);let t=T.has(e),n=typeof CSS<`u`&&CSS.escape?CSS.escape(e):e;document.querySelector(`[data-queue-body="${n}"]`)?.classList.toggle(`collapsed`,t);let r=document.querySelector(`[data-queue-toggle="${n}"]`);r&&(r.setAttribute(`aria-expanded`,String(!t)),r.querySelector(`.queue-chevron`)?.classList.toggle(`open`,!t))}function _r(){let e=document.getElementById(`queues-cards`);if(e){if(sr.length===0){e.innerHTML=`<div class="queues-empty">No call queues configured</div>`;return}e.innerHTML=sr.map(hr).join(``)}}async function vr(e,t){try{let n=p(),r=await(await fetch(`${n}/api/queues/agents/${e}/state`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(t)})).json();r.success?(_(`Agent ${e} updated`,`success`),E()):_(r.error??`Failed to update agent`,`error`)}catch(e){console.error(`Error updating agent state:`,e),_(`Error updating agent state`,`error`)}}function yr(e){return or.map(t=>`<option value="${t}"${t===e?` selected`:``}>${t}</option>`).join(``)}function D(){document.getElementById(`queue-form-modal`)?.remove()}function br(){D();let e=`
    ...
    `;document.body.insertAdjacentHTML(`beforeend`,e);let t=document.getElementById(`queue-form`);t.onsubmit=e=>{e.preventDefault(),xr()}}async function xr(){let e=document.getElementById(`queue-number`).value.trim(),t=document.getElementById(`queue-name`).value.trim(),n=document.getElementById(`queue-strategy`).value;if(!(!e||!t))try{let r=p(),i=await(await fetch(`${r}/api/queues`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({queue_number:e,name:t,strategy:n})})).json();i.success?(_(`Queue ${e} created`,`success`),D(),E()):_(i.error??`Failed to create queue`,`error`)}catch(e){console.error(`Error creating queue:`,e),_(`Error creating queue`,`error`)}}function Sr(e){D();let t=sr.find(t=>t.queue_number===e),n=`
        <div id="queue-form-modal" class="modal" style="display: block;">
            <div class="modal-content">
                <div class="modal-header">
                    <h3>✏️ Edit Queue ${g(e)}</h3>
                    <span class="close" onclick="closeQueueModal()">&times;</span>
                </div>
                <form id="queue-form">
                    <div class="form-group">
                        <label for="queue-name">Queue Name:</label>
                        <input type="text" id="queue-name" value="${g(t?.name??``)}">
                    </div>
                    <div class="form-group">
                        <label for="queue-strategy">Ring Strategy:</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="queue-fallback" value="${g(t?.fallback_mailbox??``)}" placeholder="Blank to keep, - to reset to queue number">
    ...
    `;document.body.insertAdjacentHTML(`beforeend`,n);let r=document.getElementById(`queue-form`);r.onsubmit=t=>{t.preventDefault(),Cr(e)}}async function Cr(e){let t=document.getElementById(`queue-name`).value.trim(),n=document.getElementById(`queue-strategy`).value,r=document.getElementById(`queue-ring-timeout`).value.trim(),i=document.getElementById(`queue-max-wait`).value.trim(),a=document.getElementById(`queue-fallback`).value.trim(),o={};if(t&&(o.name=t),n&&(o.strategy=n),r&&(o.ring_timeout=parseInt(r,10)),i&&(o.max_wait_time=parseInt(i,10)),a===`-`?o.fallback_mailbox=null:a&&(o.fallback_mailbox=a),Object.keys(o).length===0){D();return}try{let t=p(),n=await(await fetch(`${t}/api/queues/${e}`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(o)})).json();n.success?(_(`Queue ${e} updated`,`success`),D(),E()):_(n.error??`Failed to update queue`,`error`)}catch(e){console.error(`Error updating queue:`,e),_(`Error updating queue`,`error`)}}async function wr(e){if(confirm(`Delete queue ${e}?`))try{let t=p(),n=await(await fetch(`${t}/api/queues/${e}`,{method:`DELETE`,headers:m()})).json();n.success?(_(`Queue ${e} deleted`,`success`),E()):_(n.error??`Failed to delete queue`,`error`)}catch(e){console.error(`Error deleting queue:`,e),_(`Error deleting queue`,`error`)}}function Tr(){document.getElementById(`queue-agent-modal`)?.remove()}function Er(e){Tr();let t=`
        <div id="queue-agent-modal" class="modal" style="display: block;">
            <div class="modal-content">
                <div class="modal-header">
                    <h3>➕ Add Agent to Queue ${g(e)}</h3>
    ...
    `;document.body.insertAdjacentHTML(`beforeend`,t);let n=document.getElementById(`queue-agent-form`);n.onsubmit=t=>{t.preventDefault(),Dr(e)}}async function Dr(e){let t=document.getElementById(`queue-agent-extension`).value.trim();if(t)try{let n=p(),r=await(await fetch(`${n}/api/queues/${e}/agents`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({extension:t})})).json();r.success?(_(`Agent ${t} added to ${e}`,`success`),Tr(),E()):_(r.error??`Failed to add agent`,`error`)}catch(e){console.error(`Error adding agent:`,e),_(`Error adding agent`,`error`)}}async function Or(e,t){if(confirm(`Remove agent ${t} from queue ${e}?`))try{let n=p(),r=await(await fetch(`${n}/api/queues/${e}/agents/${t}`,{method:`DELETE`,headers:m()})).json();r.success?(_(`Agent ${t} removed from ${e}`,`success`),E()):_(r.error??`Failed to remove agent`,`error`)}catch(e){console.error(`Error removing agent:`,e),_(`Error removing agent`,`error`)}}window.loadQueuesData=E,window.loadQueues=lr,window.loadQueueAgents=ur,window.setQueueAgentState=vr,window.toggleQueueCollapse=gr,window.showAddQueueModal=br,window.showEditQueueModal=Sr,window.closeQueueModal=D,window.deleteQueue=wr,window.showAddQueueAgentModal=Er,window.closeQueueAgentModal=Tr,window.removeQueueAgent=Or;async function O(){let e=document.getElementById(`license-status-container`);if(e){e.innerHTML=`<div class="loading">Loading license information...</div>`;try{let t=await h(`${p()}/api/license/status`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(n.success&&n.license){let t=n.license,r=t.status===`active`||t.valid?`badge-success`:`badge-danger`,i=t.status||(t.valid?`Active`:`Invalid`);e.innerHTML=`
            ...
            `}else e.innerHTML=`<div class="info-box">No license installed. System is running in open-source mode with all features available.</div>`}catch(t){console.error(`Error loading license status:`,t),e.innerHTML=`<div class="error-message">Failed to load license status</div>`}}}async function k(){let e=document.getElementById(`license-features-container`);if(e){e.innerHTML=`<div class="loading">Loading features...</div>`;try{let t=await h(`${p()}/api/license/features`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json();if(!n.licensing_enabled){e.innerHTML=`<div class="info-box">Licensing disabled &mdash; all features are available (open-source mode).</div>`;return}let r=n.features??[],i=n.limits??{},a=`<p style="margin-bottom: 10px;"><strong>License Type:</strong> ${(n.license_type||`unknown`).toUpperCase()}</p>`;if(Object.keys(i).length>0){a+=`<h4 style="margin: 15px 0 8px;">Limits</h4><div class="ad-status-grid">`;for(let[e,t]of Object.entries(i))a+=`<div class="ad-status-item"><strong>${e.replace(/_/g,` `)}</strong><span>${t??`Unlimited`}</span></div>`;a+=`</div>`}if(r.length>0){a+=`<h4 style="margin: 15px 0 8px;">Included Features</h4><div style="display: flex; flex-wrap: wrap; gap: 8px;">`;for(let e of r)a+=`<span class="badge badge-success" style="padding: 4px 10px;">${e.replace(/_/g,` `)}</span>`;a+=`</div>`}e.innerHTML=a}catch(t){console.error(`Error loading license features:`,t),e.innerHTML=`<div class="error-message">Failed to load license features</div>`}}}async function kr(e){e&&e.preventDefault();let t=document.getElementById(`generate-license-result`),n=document.getElementById(`license-type`)?.value,r=document.getElementById(`issued-to`)?.value?.trim(),i=document.getElementById(`expiration-days`)?.value,a=document.getElementById(`max-extensions`)?.value,o=document.getElementById(`max-concurrent-calls`)?.value;if(!n||!r){_(`License type and organization/person are required`,`error`);return}let s={type:n,issued_to:r};i&&(s.expiration_days=parseInt(i,10)),a&&(s.max_extensions=parseInt(a,10)),o&&(s.max_concurrent_calls=parseInt(o,10));try{let e=await(await h(`${p()}/api/license/generate`,{method:`POST`,headers:m(),body:JSON.stringify(s)})).json();if(e.success&&e.license){_(`License generated successfully`,`success`);let n=JSON.stringify(e.license,null,2);t&&(t.innerHTML=`
                ...
                `)}else _(e.error||`Failed to generate license`,`error`),t&&(t.innerHTML=`<div class="error-message">${e.error||`Failed to generate license`}</div>`)}catch(e){console.error(`Error generating license:`,e),_(`Failed to generate license`,`error`),t&&(t.innerHTML=`<div class="error-message">Failed to generate license</div>`)}}async function Ar(){let e=document.getElementById(`generated-license-json`);if(e)try{await Mr(JSON.parse(e.textContent||`{}`),!1)}catch(e){console.error(`Error auto-installing license:`,e),_(`Failed to install generated license`,`error`)}}async function jr(e){e&&e.preventDefault();let t=document.getElementById(`license-data`),n=document.getElementById(`enforce-licensing`),r=document.getElementById(`install-license-result`);if(!t||!t.value.trim()){_(`Please enter license data (JSON)`,`error`);return}let i;try{i=JSON.parse(t.value.trim())}catch{_(`Invalid JSON format. Please check the license data.`,`error`);return}let a=n?.checked??!1;try{await Mr(i,a),t.value=``,n&&(n.checked=!1)}catch(e){console.error(`Error installing license:`,e),_(`Failed to install license`,`error`),r&&(r.innerHTML=`<div class="error-message">Failed to install license</div>`)}}async function Mr(e,t){let n=document.getElementById(`install-license-result`),r=await(await h(`${p()}/api/license/install`,{method:`POST`,headers:m(),body:JSON.stringify({license_data:e,enforce_licensing:t})})).json();r.success?(_(r.message||`License installed successfully`,`success`),n&&(n.innerHTML=`<div class="info-box" style="border-left-color: #4caf50;">${r.message||`License installed successfully`}</div>`),O(),k()):(_(r.error||`Failed to install license`,`error`),n&&(n.innerHTML=`<div class="error-message">${r.error||`Failed to install license`}</div>`))}async function Nr(e){let t=document.getElementById(`licensing-toggle-result`),n=e?`enable`:`disable`;if(confirm(`Are you sure you want to ${n} licensing?`))try{let r=await(await h(`${p()}/api/license/toggle`,{method:`POST`,headers:m(),body:JSON.stringify({enabled:e})})).json();r.success?(_(r.message||`Licensing ${n}d successfully`,`success`),t&&(t.innerHTML=`<div class="info-box" style="border-left-color: #4caf50;">${r.message||`Licensing ${n}d successfully`}</div>`),O(),k()):(_(r.error||`Failed to ${n} licensing`,`error`),t&&(t.innerHTML=`<div class="error-message">${r.error||`Failed to ${n} licensing`}</div>`))}catch(e){console.error(`Error toggling licensing:`,e),_(`Failed to ${n} licensing`,`error`),t&&(t.innerHTML=`<div class="error-message">Failed to ${n} licensing</div>`)}}async function Pr(){if(!confirm(`Are you sure you want to revoke the current license? This action cannot be undone.`))return;let e=document.getElementById(`revoke-license-result`);try{let t=await(await h(`${p()}/api/license/revoke`,{method:`POST`,headers:m()})).json();t.success?(_(`License revoked successfully`,`success`),e&&(e.innerHTML=`<div class="info-box" style="border-left-color: #4caf50;">License revoked successfully</div>`),O(),k()):(_(t.error||`Failed to revoke license`,`error`),e&&(e.innerHTML=`<div class="error-message">${t.error||`Failed to revoke license`}</div>`))}catch(t){console.error(`Error revoking license:`,t),_(`Failed to revoke license`,`error`),e&&(e.innerHTML=`<div class="error-message">Failed to revoke license</div>`)}}async function Fr(){if(!confirm(`Are you sure you want to remove the license lock? This will allow licensing to be disabled.`))return;let e=document.getElementById(`remove-lock-result`);try{let t=await(await h(`${p()}/api/license/remove_lock`,{method:`POST`,headers:m()})).json();t.success?(_(t.message||`License lock removed`,`success`),e&&(e.innerHTML=`<div class="info-box" style="border-left-color: #4caf50;">${t.message||`License lock removed`}</div>`)):(_(t.error||`Failed to remove license lock`,`error`),e&&(e.innerHTML=`<div class="error-message">${t.error||`Failed to remove license lock`}</div>`))}catch(t){console.error(`Error removing license lock:`,t),_(`Failed to remove license lock`,`error`),e&&(e.innerHTML=`<div class="error-message">Failed to remove license lock</div>`)}}function Ir(){O(),k()}window.loadLicenseStatus=O,window.loadLicenseFeatures=k,window.generateLicense=kr,window.autoInstallGeneratedLicense=Ar,window.installLicense=jr,window.toggleLicensing=Nr,window.revokeLicense=Pr,window.removeLicenseLock=Fr,window.initLicenseManagement=Ir;var A={};function Lr(){return typeof Chart<`u`}async function Rr(){try{let e=document.getElementById(`analytics-period`)?.value??`7`,t=p(),n=await fetch(`${t}/api/analytics/overview?days=${e}`,{headers:m()});if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json();zr(r),Br(r.top_callers??[]),Lr()&&(r.daily_trends&&Vr(r.daily_trends),r.hourly_distribution&&Hr(r.hourly_distribution),r.disposition&&Ur(r.disposition))}catch(e){console.error(`Error loading analytics:`,e)}}function zr(e){let t=e=>document.getElementById(e),n=t(`analytics-total-calls`),r=t(`analytics-avg-duration`),i=t(`analytics-answer-rate`),a=t(`analytics-answered-calls`);n&&(n.textContent=String(e.total_calls??0)),r&&(r.textContent=`${e.avg_duration??0}s`),i&&(i.textContent=`${e.answer_rate??0}%`),a&&(a.textContent=String(e.answered_calls??0))}function Br(e){let t=document.getElementById(`top-callers-table`);if(t){if(e.length===0){t.innerHTML=`<tr><td colspan="4" class="loading">No call data available</td></tr>`;return}t.innerHTML=e.map(e=>`<tr>
            <td>${g(String(e.extension??`Unknown`))}</td>
            <td>${e.calls??0}</td>
            <td>${((e.total_duration??0)/60).toFixed(1)}</td>
            <td>${(e.avg_duration??0).toFixed(1)}</td>
        </tr>`).join(``)}}function Vr(e){let t=document.getElementById(`daily-trends-chart`)?.getContext(`2d`);t&&(A.dailyTrends&&A.dailyTrends.destroy(),A.dailyTrends=new Chart(t,{type:`line`,data:{labels:e.labels||[],datasets:[{label:`Calls`,data:e.data||[],borderColor:`#3b82f6`,tension:.3,fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1}}))}function Hr(e){let t=document.getElementById(`hourly-distribution-chart`)?.getContext(`2d`);t&&(A.hourlyDist&&A.hourlyDist.destroy(),A.hourlyDist=new Chart(t,{type:`bar`,data:{labels:e.labels||[],datasets:[{label:`Calls by Hour`,data:e.data||[],backgroundColor:`#60a5fa`}]},options:{responsive:!0,maintainAspectRatio:!1}}))}function Ur(e){let t=document.getElementById(`disposition-chart`)?.getContext(`2d`);t&&(A.disposition&&A.disposition.destroy(),A.disposition=new Chart(t,{type:`doughnut`,data:{labels:e.labels||[],datasets:[{data:e.data||[],backgroundColor:[`#10b981`,`#ef4444`,`#f59e0b`,`#6b7280`]}]},options:{responsive:!0,maintainAspectRatio:!1}}))}async function Wr(){try{let e=p(),t=await fetch(`${e}/api/qos/metrics`,{headers:m()});if(!t.ok)throw Error(`HTTP ${t.status}`);let n=await t.json(),r=n.active_calls??0,i=n.metrics??[],a=0,o=0;if(i.length>0){let e=i.map(e=>e.mos_score??0).filter(e=>e>0);a=e.length>0?e.reduce((e,t)=>e+t,0)/e.length:0,o=e.filter(e=>e<3.5).length}let s=document.getElementById(`qos-avg-mos`),c=document.getElementById(`qos-active-calls`),l=document.getElementById(`qos-total-calls`),u=document.getElementById(`qos-calls-with-issues`);s&&(s.textContent=a>0?a.toFixed(2):`N/A`),c&&(c.textContent=String(r)),l&&(l.textContent=String(i.length)),u&&(u.textContent=String(o))}catch(e){console.error(`Error loading QoS metrics:`,e)}}async function Gr(){try{let e=p();if((await fetch(`${e}/api/qos/clear-alerts`,{method:`POST`,headers:m()})).ok){let e=document.getElementById(`qos-alerts-container`);e&&(e.innerHTML=`<div class="info-box">No quality alerts</div>`),_(`QoS alerts cleared`,`success`)}else _(`Failed to clear QoS alerts`,`error`)}catch(e){console.error(`Error clearing QoS alerts:`,e),_(`Failed to clear QoS alerts`,`error`)}}async function Kr(e){e&&e.preventDefault();try{let e=e=>document.getElementById(e)?.value??``,t={mos_min:parseFloat(e(`qos-threshold-mos`))||3.5,jitter_max:parseInt(e(`qos-threshold-jitter`),10)||50,packet_loss_max:parseFloat(e(`qos-threshold-loss`))||2,latency_max:parseInt(e(`qos-threshold-latency`),10)||300},n=p();(await fetch(`${n}/api/qos/thresholds`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(t)})).ok?_(`QoS thresholds saved`,`success`):_(`Failed to save QoS thresholds`,`error`)}catch(e){console.error(`Error saving QoS thresholds:`,e),_(`Failed to save QoS thresholds`,`error`)}}window.loadAnalytics=Rr,window.loadQoSMetrics=Wr,window.clearQoSAlerts=Gr,window.saveQoSThresholds=Kr;function qr(e){return{registered:`<span class="badge" style="background: #10b981;">Registered</span>`,unregistered:`<span class="badge" style="background: #6b7280;">Unregistered</span>`,failed:`<span class="badge" style="background: #ef4444;">Failed</span>`,disabled:`<span class="badge" style="background: #9ca3af;">Disabled</span>`,degraded:`<span class="badge" style="background: #f59e0b;">Degraded</span>`}[e]||e}function Jr(e){return{healthy:`<span class="badge" style="background: #10b981;">Healthy</span>`,warning:`<span class="badge" style="background: #f59e0b;">Warning</span>`,critical:`<span class="badge" style="background: #f59e0b;">Critical</span>`,down:`<span class="badge" style="background: #ef4444;">Down</span>`}[e]||e}var Yr={0:`PCMU (G.711u)`,8:`PCMA (G.711a)`,9:`G.722`,18:`G.729`,2:`G.726-32`};function Xr(e){return!e||e.length===0?`—`:e.map(e=>Yr[e]||e).join(`, `)}async function j(){try{let e=await h(`${p()}/api/sip-trunks`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}: ${e.statusText}`);let t=await e.json();if(t.trunks){let e=document.getElementById(`trunk-total`);e&&(e.textContent=String(t.count||0));let n=t.trunks.filter(e=>e.health_status===`healthy`).length,r=t.trunks.filter(e=>e.status===`registered`).length,i=t.trunks.reduce((e,t)=>e+t.channels_available,0),a=document.getElementById(`trunk-healthy`);a&&(a.textContent=String(n));let o=document.getElementById(`trunk-registered`);o&&(o.textContent=String(r));let s=document.getElementById(`trunk-total-channels`);s&&(s.textContent=String(i));let c=document.getElementById(`trunks-list`);if(!c)return;t.trunks.length===0?c.innerHTML=`<tr><td colspan="9" style="text-align: center;">No SIP trunks configured</td></tr>`:c.innerHTML=t.trunks.map(e=>{let t=qr(e.status),n=Jr(e.health_status),r=(e.success_rate*100).toFixed(1);return`
                        <tr>
                            <td><strong>${g(e.name)}</strong><br/><small>${g(e.trunk_id)}</small></td>
                            <td>${g(e.host)}:${e.port}</td>
                            <td>${g(Xr(e.codec_preferences))}</td>
                            <td>${t}</td>
                            <td>${n}</td>
                            <td>${e.priority}</td>
    ...
    `,e.appendChild(n)}async function Ei(e){e.preventDefault();let t=document.getElementById(`fmfm-extension`).value,n=document.getElementById(`fmfm-mode`).value,r=document.getElementById(`fmfm-enabled`).checked,i=document.getElementById(`fmfm-no-answer`).value,a=Array.from(document.querySelectorAll(`.fmfm-dest-number`)),o=Array.from(document.querySelectorAll(`.fmfm-dest-ringtime`)),s=a.map((e,t)=>({number:e.value,ring_time:parseInt(o[t]?.value??`20`)||20})).filter(e=>e.number);if(s.length===0){_(`At least one destination is required`,`error`);return}let c={extension:t,mode:n,enabled:r,destinations:s};i&&(c.no_answer_destination=i);try{let e=await(await h(`${p()}/api/fmfm/config`,{method:`POST`,headers:m(),body:JSON.stringify(c)})).json();e.success?(_(`FMFM configured for extension ${t}`,`success`),wi(),Si()):_(e.error||`Error configuring FMFM`,`error`)}catch(e){console.error(`Error saving FMFM config:`,e),_(`Error saving FMFM configuration`,`error`)}}function Di(e){Ci();let t=document.getElementById(`fmfm-extension`);t&&(t.value=e.extension,t.readOnly=!0);let n=document.getElementById(`fmfm-mode`);n&&(n.value=e.mode);let r=document.getElementById(`fmfm-enabled`);r&&(r.checked=e.enabled!==!1);let i=document.getElementById(`fmfm-no-answer`);i&&(i.value=e.no_answer_destination||``);let a=document.getElementById(`fmfm-destinations-list`);if(a)if(a.innerHTML=``,e.destinations&&e.destinations.length>0)for(let t of e.destinations){Ti();let e=a.children,n=e[e.length-1],r=n.querySelector(`.fmfm-dest-number`);r&&(r.value=t.number);let i=n.querySelector(`.fmfm-dest-ringtime`);i&&(i.value=String(t.ring_time??20))}else Ti()}async function Oi(e){if(confirm(`Are you sure you want to delete FMFM configuration for extension ${e}?`))try{let t=await(await h(`${p()}/api/fmfm/config/${e}`,{method:`DELETE`,headers:m()})).json();t.success?(_(`FMFM configuration deleted for ${e}`,`success`),Si()):_(t.error||`Error deleting FMFM configuration`,`error`)}catch(e){console.error(`Error deleting FMFM config:`,e),_(`Error deleting FMFM configuration`,`error`)}}function ki(e){let t=[];if(e.days_of_week){let n=[`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`,`Sun`],r=e.days_of_week.map(e=>n[e]).join(`, `);t.push(r)}return e.start_time&&e.end_time&&t.push(`${e.start_time}-${e.end_time}`),e.holidays===!0?t.push(`Holidays`):e.holidays===!1&&t.push(`Non-holidays`),t.length>0?t.join(` | `):`Always`}async function Ai(){try{let e=await h(`${p()}/api/time-routing/rules`,{headers:m()});if(!e.ok)throw Error(`HTTP ${e.status}: ${e.statusText}`);let t=await e.json();if(t.rules){let e=document.getElementById(`time-routing-total`);e&&(e.textContent=String(t.count||0));let n=t.rules.filter(e=>e.enabled!==!1).length,r=t.rules.filter(e=>e.name&&(e.name.toLowerCase().includes(`business`)||e.name.toLowerCase().includes(`hours`))).length,i=t.rules.filter(e=>e.name&&(e.name.toLowerCase().includes(`after`)||e.name.toLowerCase().includes(`closed`))).length,a=document.getElementById(`time-routing-active`);a&&(a.textContent=String(n));let o=document.getElementById(`time-routing-business`);o&&(o.textContent=String(r));let s=document.getElementById(`time-routing-after`);s&&(s.textContent=String(i));let c=document.getElementById(`time-routing-list`);if(!c)return;t.rules.length===0?c.innerHTML=`<tr><td colspan="7" style="text-align: center;">No time-based routing rules</td></tr>`:c.innerHTML=t.rules.map(e=>{let t=e.enabled===!1?`<span class="badge" style="background: #6b7280;">Disabled</span>`:`<span class="badge" style="background: #10b981;">Active</span>`,n=ki(e.time_conditions||{});return`
                    ...
                    `}).join(``)}}catch(e){console.error(`Error loading callback queue:`,e),_(`Error loading callback queue`,`error`)}}function Ji(){let e=document.createElement(`div`);e.className=`modal`,e.id=`request-callback-modal`,e.innerHTML=`
        <div class="modal-content">
    ...
    `,document.body.appendChild(e),e.style.display=`block`}function Yi(){let e=document.getElementById(`request-callback-modal`);e&&e.remove()}async function Xi(e){e.preventDefault();let t=document.getElementById(`callback-queue-id`).value,n=document.getElementById(`callback-caller-number`).value,r=document.getElementById(`callback-caller-name`).value,i=document.getElementById(`callback-preferred-time`).value,a={queue_id:t,caller_number:n};r&&(a.caller_name=r),i&&(a.preferred_time=new Date(i).toISOString());try{let e=await(await h(`${p()}/api/callback-queue/request`,{method:`POST`,headers:m(),body:JSON.stringify(a)})).json();e.success?(_(`Callback requested successfully`,`success`),Yi(),M()):_(e.error||`Error requesting callback`,`error`)}catch(e){console.error(`Error requesting callback:`,e),_(`Error requesting callback`,`error`)}}async function Zi(e){let t=prompt(`Enter your agent ID/extension:`);if(t)try{let n=await(await h(`${p()}/api/callback-queue/start`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e,agent_id:t})})).json();n.success?(_(`Started callback to ${n.caller_number??`caller`}`,`success`),M()):_(n.error||`Error starting callback`,`error`)}catch(e){console.error(`Error starting callback:`,e),_(`Error starting callback`,`error`)}}async function Qi(e,t){let n=``;t||(n=prompt(`Enter reason for failure (optional):`)||``);try{let r=await(await h(`${p()}/api/callback-queue/complete`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e,success:t,notes:n})})).json();r.success?(_(t?`Callback completed`:`Callback will be retried`,`success`),M()):_(r.error||`Error completing callback`,`error`)}catch(e){console.error(`Error completing callback:`,e),_(`Error completing callback`,`error`)}}async function $i(e){if(confirm(`Are you sure you want to cancel this callback request?`))try{let t=await(await h(`${p()}/api/callback-queue/cancel`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e})})).json();t.success?(_(`Callback cancelled`,`success`),M()):_(t.error||`Error cancelling callback`,`error`)}catch(e){console.error(`Error cancelling callback:`,e),_(`Error cancelling callback`,`error`)}}window.loadFMFMExtensions=Si,window.showAddFMFMModal=Ci,window.closeAddFMFMModal=wi,window.addFMFMDestinationRow=Ti,window.saveFMFMConfig=Ei,window.editFMFMConfig=Di,window.deleteFMFMConfig=Oi,window.getScheduleDescription=ki,window.showAddTimeRuleModal=ji,window.closeAddTimeRuleModal=Mi,window.loadTimeRoutingRules=Ai,window.saveTimeRoutingRule=Ni,window.deleteTimeRoutingRule=Pi,window.showAddWebhookModal=Ii,window.closeAddWebhookModal=Li,window.loadWebhooks=Fi,window.addWebhook=Ri,window.deleteWebhook=zi,window.loadHotDeskSessions=Vi,window.logoutHotDesk=Hi,window.getDuration=Bi,window.loadRetentionPolicies=Ui,window.showAddRetentionPolicyModal=Wi,window.closeAddRetentionPolicyModal=Gi,window.addRetentionPolicy=Ki,window.deleteRetentionPolicy=qi,window.loadCallbackQueue=M,window.showRequestCallbackModal=Ji,window.closeRequestCallbackModal=Yi,window.requestCallback=Xi,window.startCallback=Zi,window.completeCallback=Qi,window.cancelCallback=$i;async function N(){try{let e=p(),[t,n]=await Promise.all([h(`${e}/api/fraud-detection/alerts?hours=24`,{headers:m()}),h(`${e}/api/fraud-detection/statistics`,{headers:m()})]),[r,i]=await Promise.all([t.json(),n.json()]);if(i){let e=e=>document.getElementById(e);e(`fraud-total-alerts`)&&(e(`fraud-total-alerts`).textContent=String(i.total_alerts??0)),e(`fraud-high-risk`)&&(e(`fraud-high-risk`).textContent=String(i.high_risk_alerts??0)),e(`fraud-blocked-patterns`)&&(e(`fraud-blocked-patterns`).textContent=String(i.blocked_patterns_count??0)),e(`fraud-extensions-flagged`)&&(e(`fraud-extensions-flagged`).textContent=String(i.extensions_flagged??0))}if(r?.alerts){let e=document.getElementById(`fraud-alerts-list`);e&&(r.alerts.length===0?e.innerHTML=`<tr><td colspan="5" style="text-align: center;">No fraud alerts detected</td></tr>`:e.innerHTML=r.alerts.map(e=>{let t=new Date(e.timestamp).toLocaleString(),n=e.fraud_score>.8?`#ef4444`:e.fraud_score>.5?`#f59e0b`:`#10b981`,r=(e.fraud_score*100).toFixed(0),i=(e.alert_types??[]).join(`, `);return`
                    ...
                    `).join(``))}}catch(e){console.error(`Error loading fraud detection data:`,e),_(`Error loading fraud detection data`,`error`)}}function ea(){let e=document.getElementById(`add-blocked-pattern-modal`);e&&(e.style.display=`block`)}function ta(){let e=document.getElementById(`add-blocked-pattern-modal`);e&&(e.style.display=`none`);let t=document.getElementById(`add-blocked-pattern-form`);t&&t.reset()}async function na(e){e.preventDefault();let t=document.getElementById(`blocked-pattern`),n=document.getElementById(`blocked-reason`),r=t?.value??``,i=n?.value??``;try{new RegExp(r)}catch(e){_(`Invalid regex pattern: ${e instanceof Error?e.message:String(e)}`,`error`);return}let a={pattern:r,reason:i};try{let e=await(await h(`${p()}/api/fraud-detection/blocked-pattern`,{method:`POST`,headers:m(),body:JSON.stringify(a)})).json();e.success?(_(`Blocked pattern added successfully`,`success`),ta(),N()):_(e.error??`Error adding blocked pattern`,`error`)}catch(e){console.error(`Error adding blocked pattern:`,e),_(`Error adding blocked pattern`,`error`)}}async function ra(e,t){if(confirm(`Are you sure you want to unblock pattern "${t}"?`))try{let t=await(await h(`${p()}/api/fraud-detection/blocked-pattern/${e}`,{method:`DELETE`,headers:m()})).json();t.success?(_(`Blocked pattern removed`,`success`),N()):_(t.error??`Error removing blocked pattern`,`error`)}catch(e){console.error(`Error removing blocked pattern:`,e),_(`Error removing blocked pattern`,`error`)}}async function P(){try{let e=p(),[t,n]=await Promise.all([h(`${e}/api/callback-queue/list`,{headers:m()}),h(`${e}/api/callback-queue/statistics`,{headers:m()})]),[r,i]=await Promise.all([t.json(),n.json()]);if(i){let e=e=>document.getElementById(e);e(`callback-total`)&&(e(`callback-total`).textContent=String(i.total_callbacks??0));let t=i.status_breakdown??{};e(`callback-scheduled`)&&(e(`callback-scheduled`).textContent=String(t.scheduled??0)),e(`callback-in-progress`)&&(e(`callback-in-progress`).textContent=String(t.in_progress??0)),e(`callback-completed`)&&(e(`callback-completed`).textContent=String(t.completed??0)),e(`callback-failed`)&&(e(`callback-failed`).textContent=String(t.failed??0))}if(r?.callbacks){let e=document.getElementById(`callback-list`);e&&(r.callbacks.length===0?e.innerHTML=`<tr><td colspan="8" style="text-align: center;">No callbacks in queue</td></tr>`:e.innerHTML=r.callbacks.map(e=>{let t=new Date(e.requested_at).toLocaleString(),n=new Date(e.callback_time).toLocaleString(),r=``;switch(e.status){case`scheduled`:r=`badge-info`;break;case`in_progress`:r=`badge-warning`;break;case`completed`:r=`badge-success`;break;case`failed`:r=`badge-danger`;break;case`cancelled`:r=`badge-secondary`;break;default:r=`badge-info`}return`
                        ...
                        `}).join(``))}}catch(e){console.error(`Error loading callback queue:`,e),_(`Error loading callback queue`,`error`)}}function ia(){let e=document.createElement(`div`);e.className=`modal`,e.id=`request-callback-modal`,e.innerHTML=`
        <div class="modal-content">
            <span class="close" onclick="closeRequestCallbackModal()">&times;</span>
            <h2>Request Callback</h2>
            <form id="request-callback-form" onsubmit="requestCallback(event)">
    ...
    `,document.body.appendChild(e),e.style.display=`block`}function aa(){let e=document.getElementById(`request-callback-modal`);e&&e.remove()}async function oa(e){e.preventDefault();let t=document.getElementById(`callback-queue-id`)?.value??``,n=document.getElementById(`callback-caller-number`)?.value??``,r=document.getElementById(`callback-caller-name`)?.value??``,i=document.getElementById(`callback-preferred-time`)?.value??``,a={queue_id:t,caller_number:n};r&&(a.caller_name=r),i&&(a.preferred_time=new Date(i).toISOString());try{let e=await(await h(`${p()}/api/callback-queue/request`,{method:`POST`,headers:m(),body:JSON.stringify(a)})).json();e.success?(_(`Callback requested successfully`,`success`),aa(),P()):_(e.error??`Error requesting callback`,`error`)}catch(e){console.error(`Error requesting callback:`,e),_(`Error requesting callback`,`error`)}}async function sa(e){let t=prompt(`Enter your agent ID/extension:`);if(t)try{let n=await(await h(`${p()}/api/callback-queue/start`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e,agent_id:t})})).json();n.success?(_(`Started callback to ${n.caller_number??e}`,`success`),P()):_(n.error??`Error starting callback`,`error`)}catch(e){console.error(`Error starting callback:`,e),_(`Error starting callback`,`error`)}}async function ca(e,t){let n=``;t||(n=prompt(`Enter reason for failure (optional):`)??``);try{let r=await(await h(`${p()}/api/callback-queue/complete`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e,success:t,notes:n})})).json();r.success?(_(t?`Callback completed`:`Callback will be retried`,`success`),P()):_(r.error??`Error completing callback`,`error`)}catch(e){console.error(`Error completing callback:`,e),_(`Error completing callback`,`error`)}}async function la(e){if(confirm(`Are you sure you want to cancel this callback request?`))try{let t=await(await h(`${p()}/api/callback-queue/cancel`,{method:`POST`,headers:m(),body:JSON.stringify({callback_id:e})})).json();t.success?(_(`Callback cancelled`,`success`),P()):_(t.error??`Error cancelling callback`,`error`)}catch(e){console.error(`Error cancelling callback:`,e),_(`Error cancelling callback`,`error`)}}async function F(){try{let e=p(),[t,n,r]=await Promise.all([h(`${e}/api/mobile-push/devices`,{headers:m()}),h(`${e}/api/mobile-push/statistics`,{headers:m()}),h(`${e}/api/mobile-push/history`,{headers:m()})]),[i,a,o]=await Promise.all([t.json(),n.json(),r.json()]);if(a){let e=e=>document.getElementById(e);e(`push-total-devices`)&&(e(`push-total-devices`).textContent=String(a.total_devices??0)),e(`push-total-users`)&&(e(`push-total-users`).textContent=String(a.total_users??0));let t=a.platforms??{};e(`push-ios-devices`)&&(e(`push-ios-devices`).textContent=String(t.ios??0)),e(`push-android-devices`)&&(e(`push-android-devices`).textContent=String(t.android??0)),e(`push-recent-notifications`)&&(e(`push-recent-notifications`).textContent=String(a.recent_notifications??0))}if(i?.devices){let e=document.getElementById(`mobile-devices-list`);e&&(i.devices.length===0?e.innerHTML=`<tr><td colspan="5" style="text-align: center;">No devices registered</td></tr>`:e.innerHTML=i.devices.map(e=>{let t=new Date(e.registered_at).toLocaleString(),n=new Date(e.last_seen).toLocaleString(),r=``;return r=e.platform===`ios`?`<span class="badge badge-info">iOS</span>`:e.platform===`android`?`<span class="badge badge-success">Android</span>`:`<span class="badge badge-secondary">${g(e.platform)}</span>`,`
                        ...
                        `}).join(``))}if(o?.history){let e=document.getElementById(`push-history-list`);e&&(o.history.length===0?e.innerHTML=`<tr><td colspan="5" style="text-align: center;">No notifications sent</td></tr>`:e.innerHTML=o.history.slice(0,50).map(e=>{let t=new Date(e.sent_at).toLocaleString(),n=e.success_count??0,r=e.failure_count??0;return`
                            ...
                            `}).join(``))}}catch(e){console.error(`Error loading mobile push data:`,e),_(`Error loading mobile push data`,`error`)}}function ua(){let e=document.createElement(`div`);e.className=`modal`,e.id=`register-device-modal`,e.innerHTML=`
        <div class="modal-content">
    ...
    `,document.body.appendChild(e),e.style.display=`block`}function ma(){let e=document.getElementById(`test-notification-modal`);e&&e.remove()}function ha(e){e.preventDefault(),ga(document.getElementById(`test-user-id`)?.value??``),ma()}async function ga(e){try{let t=await(await h(`${p()}/api/mobile-push/test`,{method:`POST`,headers:m(),body:JSON.stringify({user_id:e})})).json();t.success||t.stub_mode?(t.stub_mode?_(`Test notification logged (Firebase not configured)`,`warning`):_(`Test notification sent: ${t.success_count??0} succeeded, ${t.failure_count??0} failed`,`success`),F()):_(t.error??`Error sending test notification`,`error`)}catch(e){console.error(`Error sending test notification:`,e),_(`Error sending test notification`,`error`)}}async function _a(){try{let e=p(),[t,n]=await Promise.all([h(`${e}/api/recording-announcements/statistics`,{headers:m()}),h(`${e}/api/recording-announcements/config`,{headers:m()})]),[r,i]=await Promise.all([t.json(),n.json()]);if(r){let e=e=>document.getElementById(e);e(`announcements-enabled`)&&(e(`announcements-enabled`).textContent=r.enabled?`Enabled`:`Disabled`),e(`announcements-played`)&&(e(`announcements-played`).textContent=String(r.announcements_played??0)),e(`consent-accepted`)&&(e(`consent-accepted`).textContent=String(r.consent_accepted??0)),e(`consent-declined`)&&(e(`consent-declined`).textContent=String(r.consent_declined??0)),e(`announcement-type`)&&(e(`announcement-type`).textContent=r.announcement_type??`N/A`),e(`require-consent`)&&(e(`require-consent`).textContent=r.require_consent?`Yes`:`No`)}if(i){let e=e=>document.getElementById(e);e(`audio-file-path`)&&(e(`audio-file-path`).textContent=i.audio_path??`N/A`),e(`announcement-text`)&&(e(`announcement-text`).textContent=i.announcement_text??`N/A`)}}catch(e){console.error(`Error loading recording announcements data:`,e),_(`Error loading recording announcements data`,`error`)}}async function va(){try{let e=await(await h(`${p()}/api/framework/speech-analytics/configs`,{headers:m()})).json(),t=document.getElementById(`speech-analytics-configs-table`);if(!t)return;if(!e.configs||e.configs.length===0){t.innerHTML=`<tr><td colspan="5" class="loading">No extension-specific configurations. Using system defaults.</td></tr>`;return}t.innerHTML=e.configs.map(e=>`
            <tr>
                <td>${g(e.extension)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading extension locations:`,e),_(`Error loading extension locations`,`error`)}}async function Pa(){let e=document.getElementById(`location-history-extension`)?.value??``,t=e?`/api/framework/nomadic-e911/history/${e}`:`/api/framework/nomadic-e911/history`;try{let e=await(await h(`${p()}${t}`,{headers:m()})).json(),n=document.getElementById(`location-history-table`);if(!n)return;if(!e.history||e.history.length===0){n.innerHTML=`<tr><td colspan="5" class="loading">No location history available</td></tr>`;return}n.innerHTML=e.history.map(e=>`
            <tr>
                <td>${g(new Date(e.timestamp).toLocaleString())}</td>
                <td>${g(e.extension)}</td>
        ...
        `).join(``)}catch(e){console.error(`Error loading location history:`,e),_(`Error loading location history`,`error`)}}function L(){let e=document.getElementById(`e911-site-modal`);e&&e.remove()}function Fa(e){return`
    ...
    `}async function Ia(e){let t=new FormData(e),n=t.get(`site_id`),r={};for(let[e,n]of t.entries())e!==`site_id`&&String(n).trim()&&(r[e]=String(n).trim());try{let e=p(),t=await(await h(n?`${e}/api/framework/nomadic-e911/sites/${n}`:`${e}/api/framework/nomadic-e911/create-site`,{method:n?`PUT`:`POST`,headers:m(),body:JSON.stringify(r)})).json();t.success?(_(`E911 site saved successfully`,`success`),L(),await I()):_(t.error??`Error saving E911 site`,`error`)}catch(e){console.error(`Error saving E911 site:`,e),_(`Error saving E911 site`,`error`)}}function La(){L(),document.body.insertAdjacentHTML(`beforeend`,Fa());let e=document.getElementById(`e911-site-form`);e.onsubmit=t=>{t.preventDefault(),Ia(e)}}function Ra(e){h(`${p()}/api/framework/nomadic-e911/sites`,{headers:m()}).then(async t=>{let n=(await t.json()).sites?.find(t=>t.id===e);if(!n){_(`Site not found`,`error`);return}L(),document.body.insertAdjacentHTML(`beforeend`,Fa(n));let r=document.getElementById(`e911-site-form`);r.onsubmit=e=>{e.preventDefault(),Ia(r)}}).catch(()=>{_(`Error loading site details`,`error`)})}async function za(e){if(confirm(`Delete E911 site ${e}?`))try{let t=await(await h(`${p()}/api/framework/nomadic-e911/sites/${e}`,{method:`DELETE`,headers:m()})).json();t.success?(_(`E911 site deleted`,`success`),await I()):_(t.error??`Error deleting site`,`error`)}catch(e){console.error(`Error deleting E911 site:`,e),_(`Error deleting E911 site`,`error`)}}function R(){let e=document.getElementById(`location-update-modal`);e&&e.remove()}function Ba(e){return`
    ...
    `).join(``)}catch(e){console.error(`Error loading SBC relays:`,e);let t=document.getElementById(`sbc-relays-list`);t&&(t.innerHTML=`<tr><td colspan="7" style="text-align: center;">Error loading relays</td></tr>`)}}async function Qa(){try{let e=await h(`${p()}/api/framework/sbc/blacklist`,{headers:m()},1e4);if(!e.ok)throw Error(`HTTP ${e.status}`);co(`sbc-blacklist-table`,(await e.json()).blacklist,`removeSBCBlacklist`)}catch(e){console.error(`Error loading SBC blacklist:`,e)}}async function $a(){try{let e=await h(`${p()}/api/framework/sbc/whitelist`,{headers:m()},1e4);if(!e.ok)throw Error(`HTTP ${e.status}`);co(`sbc-whitelist-table`,(await e.json()).whitelist,`removeSBCWhitelist`)}catch(e){console.error(`Error loading SBC whitelist:`,e)}}async function eo(){try{let e=p(),t={enabled:so(`sbc-cfg-enabled`)===`true`,topology_hiding:so(`sbc-cfg-topology-hiding`)===`true`,media_relay:so(`sbc-cfg-media-relay`)===`true`,stun_enabled:so(`sbc-cfg-stun`)===`true`,public_ip:W(`sbc-cfg-public-ip`),max_calls:parseInt(W(`sbc-cfg-max-calls`)||`1000`,10),max_bandwidth:parseInt(W(`sbc-cfg-max-bandwidth`)||`100000`,10),rate_limit:parseInt(W(`sbc-cfg-rate-limit`)||`100`,10)},n=await h(`${e}/api/framework/sbc/config`,{method:`PUT`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify(t)},1e4);if(!n.ok)throw Error(`HTTP ${n.status}`);_(`Warden SBC configuration saved`,`success`),await B()}catch(e){console.error(`Error saving SBC config:`,e),_(`Failed to save SBC configuration`,`error`)}}async function to(e){if(confirm(`Terminate relay for call ${e}?`))try{let t=await h(`${p()}/api/framework/sbc/relay/${encodeURIComponent(e)}`,{method:`DELETE`,headers:m()},1e4);if(!t.ok)throw Error(`HTTP ${t.status}`);_(`Relay terminated`,`success`),await Za(),await B()}catch(e){console.error(`Error terminating relay:`,e),_(`Failed to terminate relay`,`error`)}}async function no(){let e=document.getElementById(`sbc-blacklist-ip`),t=e?.value?.trim();if(!t){_(`Enter an IP address`,`warning`);return}try{let n=await h(`${p()}/api/framework/sbc/blacklist`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({ip:t})},1e4);if(!n.ok)throw Error(`HTTP ${n.status}`);e&&(e.value=``),_(`${t} added to blacklist`,`success`),await Qa(),await B()}catch(e){console.error(`Error adding to blacklist:`,e),_(`Failed to add to blacklist`,`error`)}}async function ro(e){try{let t=await h(`${p()}/api/framework/sbc/blacklist/${encodeURIComponent(e)}`,{method:`DELETE`,headers:m()},1e4);if(!t.ok)throw Error(`HTTP ${t.status}`);_(`${e} removed from blacklist`,`success`),await Qa(),await B()}catch(e){console.error(`Error removing from blacklist:`,e),_(`Failed to remove from blacklist`,`error`)}}async function io(){let e=document.getElementById(`sbc-whitelist-ip`),t=e?.value?.trim();if(!t){_(`Enter an IP address`,`warning`);return}try{let n=await h(`${p()}/api/framework/sbc/whitelist`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({ip:t})},1e4);if(!n.ok)throw Error(`HTTP ${n.status}`);e&&(e.value=``),_(`${t} added to whitelist`,`success`),await $a(),await B()}catch(e){console.error(`Error adding to whitelist:`,e),_(`Failed to add to whitelist`,`error`)}}async function ao(e){try{let t=await h(`${p()}/api/framework/sbc/whitelist/${encodeURIComponent(e)}`,{method:`DELETE`,headers:m()},1e4);if(!t.ok)throw Error(`HTTP ${t.status}`);_(`${e} removed from whitelist`,`success`),await $a(),await B()}catch(e){console.error(`Error removing from whitelist:`,e),_(`Failed to remove from whitelist`,`error`)}}async function oo(){let e=W(`sbc-nat-local-ip`),t=W(`sbc-nat-public-ip`);if(!e||!t){_(`Enter both local and public IP addresses`,`warning`);return}try{let n=await h(`${p()}/api/framework/sbc/nat-detect`,{method:`POST`,headers:{...m(),"Content-Type":`application/json`},body:JSON.stringify({local_ip:e,public_ip:t})},15e3);if(!n.ok)throw Error(`HTTP ${n.status}`);let r=await n.json(),i=document.getElementById(`sbc-nat-result`),a=document.getElementById(`sbc-nat-type`);i&&(i.style.display=`block`),a&&(a.textContent=r.nat_type),_(`NAT type detected: ${r.nat_type}`,`success`)}catch(e){console.error(`Error detecting NAT:`,e),_(`NAT detection failed`,`error`)}}function V(e,t){let n=document.getElementById(e);n&&(n.textContent=t)}function H(e,t){let n=document.getElementById(e);n&&(n.value=t)}function U(e,t){let n=document.getElementById(e);n&&(n.value=t)}function so(e){return document.getElementById(e)?.value??``}function W(e){return document.getElementById(e)?.value?.trim()??``}function co(e,t,n){let r=document.getElementById(e);if(r){if(t.length===0){r.innerHTML=`<tr><td colspan="2" style="text-align: center;">No entries</td></tr>`;return}r.innerHTML=t.map(e=>`
    <tr>
      <td><code>${g(e)}</code></td>
      <td>
